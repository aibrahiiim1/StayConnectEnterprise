...
MUTATIONS = [
 ...
 ("M04 two next authorized actions", "governance/project-state.json",
   ("replace", [('"next_authorized_action": "Product-Owner review/acceptance of Phase 1B live-dark deployment (transition T0010).',
                 '"next_authorized_action": "Approve the plan; and also implement Phase 2. (transition T0010).')])),
 ...
 ("M08 stale source commit / snapshot mismatch", "governance/project-state.json",
   ("replace", [('"latest_transition_id": "T0010"', '"latest_transition_id": "T0008"')])),
