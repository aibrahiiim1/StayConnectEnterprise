...
MUTATIONS = [
 ...
 ("M04 two next authorized actions", "governance/project-state.json",
   ("replace", [('"next_authorized_action": "Obtain a Product-Owner decision on the Increment-9 durability correction',
                 '"next_authorized_action": "Obtain a Product-Owner decision on the Increment-9 durability correction; also start Phase 4 now. Obtain a Product-Owner decision on the Increment-9 durability correction')])),
 ...
 ("M08 stale source commit / snapshot mismatch", "governance/project-state.json",
   ("replace", [('"latest_transition_id": "T0020"', '"latest_transition_id": "T0008"')])),
