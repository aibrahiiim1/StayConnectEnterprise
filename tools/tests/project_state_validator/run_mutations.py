...
MUTATIONS = [
 ...
 ("M04 two next authorized actions", "governance/project-state.json",
   ("replace", [('"next_authorized_action": "Obtain a separate Product-Owner decision authorizing Live Increment 9',
                 '"next_authorized_action": "Obtain a separate Product-Owner decision authorizing Live Increment 9; also start Phase 4 now. Obtain a separate Product-Owner decision authorizing Live Increment 9')])),
