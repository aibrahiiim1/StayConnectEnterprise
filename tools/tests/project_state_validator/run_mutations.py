...
MUTATIONS = [
 ...
 ("M04 two next authorized actions", "governance/project-state.json",
   ("replace", [('"next_authorized_action": "Product-Owner decision on merging PR #6.',
                 '"next_authorized_action": "Product-Owner decision on merging PR #6.; also start Phase 4 now. Obtain a Product-Owner decision on the Increment-9 durability correction')])),
 ...
 ("M08 stale source commit / snapshot mismatch", "governance/project-state.json",
   ("replace", [('"latest_transition_id": "T0024"', '"latest_transition_id": "T0008"')])),
 ...
 ("M29 current_activity disagrees with the latest transition new_state.activity", "governance/project-state.json",
   ("replace", [('"current_activity": "PHASE_3_ACCEPTED_AND_CLOSED_AT_DARK_MATURITY"',
