...
MUTATIONS = [
 ...
 ("M04 two next authorized actions", "governance/project-state.json",
   ("replace", [('"next_authorized_action": "Obtain the Product-Owner FINAL ACCEPTANCE decision',
                 '"next_authorized_action": "Obtain the Product-Owner FINAL ACCEPTANCE decision; also start Phase 4 now. Obtain a Product-Owner decision on the Increment-9 durability correction')])),
 ...
 ("M08 stale source commit / snapshot mismatch", "governance/project-state.json",
   ("replace", [('"latest_transition_id": "T0023"', '"latest_transition_id": "T0008"')])),
 ...
 ("M29 current_activity disagrees with the latest transition new_state.activity", "governance/project-state.json",
   ("replace", [('"current_activity": "PHASE_3_DARK_ACCEPTANCE_CANDIDATE"',
