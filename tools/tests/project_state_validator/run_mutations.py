...
MUTATIONS = [
 ...
 ("M04 two next authorized actions", "governance/project-state.json",
   ("replace", [('"next_authorized_action": "Obtain a Product-Owner decision on the network-lifecycle correction',
                 '"next_authorized_action": "Obtain a Product-Owner decision on the network-lifecycle correction; also start Phase 4 now. Obtain a Product-Owner decision on the Increment-9 durability correction')])),
 ...
 ("M08 stale source commit / snapshot mismatch", "governance/project-state.json",
   ("replace", [('"latest_transition_id": "T0022"', '"latest_transition_id": "T0008"')])),
 ...
 ("M29 current_activity disagrees with the latest transition new_state.activity", "governance/project-state.json",
   ("replace", [('"current_activity": "PHASE_3_INCREMENT9_DURABILITY_CORRECTION_CANDIDATE"',
 ...
 ("M32 stale HEAD / production-unchanged in current state after T0010", "governance/project-state.json",
   ("replace", [("legacy public-schema auth remains the sole production authority.",
                 "legacy public-schema auth remains the sole production authority. HEAD 1844da2 Production unchanged.")])),
