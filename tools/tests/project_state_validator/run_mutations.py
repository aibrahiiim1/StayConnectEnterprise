...
MUTATIONS = [
 ...
 ("M04 two next authorized actions", "governance/project-state.json",
   ("replace", [('"next_authorized_action": "Await explicit Product-Owner authorization for Phase 3',
                 '"next_authorized_action": "Await explicit Product-Owner authorization; also start Phase 3 now. Await explicit Product-Owner authorization for Phase 3')])),
 ...
 ("M08 stale source commit / snapshot mismatch", "governance/project-state.json",
   ("replace", [('"latest_transition_id": "T0014"', '"latest_transition_id": "T0008"')])),
 ...
 ("M31 post-merge: an allowed_action reintroduces the completed PR #4 merge", "governance/project-state.json",
   ("replace", [("Read-only verification and inspection of the accepted, closed, merged Phase 2 (commercial packages)",
                 "Merge PR #4 to master with provenance preserved and run post-merge governance verification")])),
 ...
 ("M35 closed/merged but an allowed_action still says merge PR #2", "governance/project-state.json",
   ("replace", [("Governance and documentation maintenance only (no runtime code change, no migration, no appliance deploy/restart/reboot, no flag enablement)",
 ...
 ("M37 phase2 transition pointer stuck at T0012 after closure (T0014)", "governance/project-state.json",
   ("replace", [('"transition_id": "T0014",', '"transition_id": "T0012",')])),
 ...
 ("M46 change-manifest lists a path not present in git base..HEAD", "docs/manifests/Phase2-change-manifest.md",
