...
for m in 0011_phase4_financial_execution 0012_phase4_financial_hardening 0013_phase4_reversal_ledger 0014_phase4_payment_settlement; do
...
echo "  iam_v2 tables=$pre + 0011 + 0012 + 0013 + 0014 applied"
