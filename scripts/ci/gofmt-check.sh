...
# guard) plus the seven Phase-3 command roots. Run from data-plane/.
#
...
set -uo pipefail
targets=(internal/ cmd/pmsd cmd/scd cmd/portald cmd/edged cmd/acctd cmd/netd cmd/phase3-foundation)
