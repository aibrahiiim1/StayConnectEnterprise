...
- **SOURCE_DOCUMENTATION_SYNC_COMMIT:** `d5a5862` — `docs(iam): remove residual Phase-1A planning-only / scratch-only current-state contradictions; harden validator`. Every copied document matches `d5a5862` (supersedes `d0eabc2`/`22a2e15`).
- **PROJECT_PACK_EXPORT_COMMIT:** `24de06e` — the exact commit that introduced this regenerated pack (this line is stamped with the real hash after that commit exists).
...
|---|---|---|---|---|---|
| 1 | `00-START-HERE.md` | *(generated)* | `d5a5862` | Entry point | `83368925bd1934e1ef7768445da0b086ab0282b465d7c4573fc7ee09acc82767` |
| 2 | `PROJECT-INSTRUCTIONS.md` | *(generated)* | `d5a5862` | Project config | `08c6b812aa3c98bd5720f93e777de4c89a606c234302a92fd1fc748701684851` |
| 3 | `StayConnect-IAM-Phase0-Contract.md` | `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | `d5a5862` | **Authoritative** *(sanitized)* | `2466700be2ae2bafa0304d98b6ae062f241b451a61af377f912094ed8961f89c` |
| 4 | `StayConnect-IAM-Handoff.md` | `docs/context/StayConnect-IAM-Handoff.md` | `d5a5862` | **Authoritative** | `2e1f3299a889e1fc32542db3bc4a876ede0d100a271c3d18d36ea4dfcbe6b1b0` |
| 5 | `StayConnect-IAM-Phase1A-Plan.md` | `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | `d5a5862` | **Authoritative** | `d930b9696153502148f13aae3862409a35e0ccc3796c870e86c2b0edc3715bff` |
| 6 | `StayConnect-IAM-Phase1A-Live-Dark-Acceptance.md` | `docs/acceptance/StayConnect-IAM-Phase1A-Live-Dark-Acceptance.md` | `d5a5862` | **Authoritative (acceptance record)** | `66f5f2a9b2c4fced2e6b42a2ff1c7c4e4ee6d3a74e4f483dbfc1c3bcad4d6ec9` |
| 7 | `Protel-FIAS-Phase0-Spike.md` | `docs/spikes/Protel-FIAS-Phase0-Spike.md` | `d5a5862` | **Authoritative** *(sanitized)* | `a55039b86e098f67a8e92c0f6e14b903a5195f0fe7053701cc6001589b135486` |
| 8 | `ZERO_STALE_LEFTOVERS_RULE.md` | `docs/ZERO_STALE_LEFTOVERS_RULE.md` | `d5a5862` | **Permanent rule (full text)** | `f4393729db5f264fbba585127f8b8ee70c3ea20da69e065523604100505a32ed` |
| 9 | `SYSTEM_OVERVIEW.md` | `docs/SYSTEM_OVERVIEW.md` | `d5a5862` | Historical snapshot | `3b5cc376451a8bec9907793e0cb5ef70aff231c67b52cf4d05e0e78be53f04e4` |
| 10 | `TARGET_ARCHITECTURE.md` | `docs/TARGET_ARCHITECTURE.md` | `d5a5862` | Supporting | `dd5b653ade4fbf1bffde1fc97e7f4e2d7fc3d3c9131bd05517b06c6430aa2dda` |
| 11 | `STAYCONNECT_COMPLETE_OPERATIONS_MANUAL.md` | `docs/STAYCONNECT_COMPLETE_OPERATIONS_MANUAL.md` | `d5a5862` | Supporting | `37f2022028148769b861b5d446427404a3aaa9545172ada0b24a60451c36e138` |
| 12 | `DEPLOYMENT_APPLIANCE.md` | `docs/DEPLOYMENT_APPLIANCE.md` | `d5a5862` | Supporting | `7e76f07e06785e58683d95dd5cadbbcc3f7ccbade77df5ab452dbf1c289ed773` |
| 13 | `OFFLINE_OPERATION.md` | `docs/OFFLINE_OPERATION.md` | `d5a5862` | Supporting | `3232e52f03e7a07089929703e261c27da879258f1dcac67b9c597b8942b69f20` |
| 14 | `MIGRATION_RUNBOOK.md` | `docs/MIGRATION_RUNBOOK.md` | `d5a5862` | Supporting | `737935641c4d8d0d5de9fd7a7d627aa634d215d2accf9867c76f5d25b658ca55` |
