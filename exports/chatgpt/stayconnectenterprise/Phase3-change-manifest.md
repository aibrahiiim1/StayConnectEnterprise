...
- **HEAD commit:** `7560dd0`
- **Provenance (generation HEAD = inventory_head):** `7560dd0131ae24dc354fd020900617e91c95d498`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_7560dd0.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  984 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1791 ++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 294582 bytes
 ...
 .../chatgpt/phase-evidence/GIT_STAT_7560dd0.txt    |    4 +
 ...
 331 files changed, 68473 insertions(+), 728 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_7560dd0.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_ffaaabe.txt
