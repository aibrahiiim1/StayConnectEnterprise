...
- **HEAD commit:** `f2771dc`
- **Provenance (generation HEAD = inventory_head):** `980b8b854501b203dd952558e7709aa2c6905a71`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_980b8b8.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           | 1211 ++++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 2018 +++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 300272 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111150 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42053 bytes
 .../chatgpt/phase-evidence/GIT_STAT_980b8b8.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1211 ++++++++
 ...
 415 files changed, 86995 insertions(+), 2119 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_980b8b8.txt
...
```text
HISTORICAL: 980b8b8 Phase 4 (delivery_head): T0041 receipt, complete staged manifest, rebuilt packs, pointer and report-embedded manifest
