...
| `exports/chatgpt/phase-evidence/GIT_STAT_a1f0c4e.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | @ Phase 3 Hotel-Admin surface (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  429 +++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 277905 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 103243 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 41998 bytes
 .../chatgpt/phase-evidence/GIT_STAT_9a1f356.txt    |    4 -
 .../chatgpt/phase-evidence/GIT_STAT_a1f0c4e.txt    |    4 +
 ...
 139 files changed, 19924 insertions(+), 357 deletions(-)
```
