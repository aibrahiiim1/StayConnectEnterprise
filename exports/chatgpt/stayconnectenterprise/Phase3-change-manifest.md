...
- **HEAD commit:** `fb15bf036b56f6c7c084e7bdd90eac29a7e4c661`
- **Provenance (generation HEAD = inventory_head):** `fb15bf036b56f6c7c084e7bdd90eac29a7e4c661`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `data-plane/cmd/acctd/phase3.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
| `data-plane/cmd/acctd/phase3_accounting.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 (C): durable accounting checkpoints + absolute-counter controlled ingestion + netd class epochs |
| `data-plane/cmd/acctd/phase3_boundary_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `data-plane/cmd/acctd/phase3_ingest_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 (C): durable accounting checkpoints + absolute-counter controlled ingestion + netd class epochs |
| `data-plane/cmd/acctd/phase3_pass_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 (C): durable accounting checkpoints + absolute-counter controlled ingestion + netd class epochs |
| `data-plane/cmd/acctd/phase3_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `data-plane/cmd/netd/main.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `data-plane/cmd/netd/phase3_shaping.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
| `data-plane/cmd/netd/phase3_shaping_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `data-plane/cmd/scd/phase3_auth.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
| `data-plane/cmd/scd/phase3_auth_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `data-plane/internal/shapeplan/plan.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `data-plane/migrations/0010_phase3_stay_resolution.down.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
| `data-plane/migrations/0010_phase3_stay_resolution.up.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `docs/PHASE3_DEPLOYMENT_AND_ROLLBACK_RUNBOOK.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
| `docs/PHASE3_SCOPE_AMENDMENT_PROPOSAL.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `docs/architecture/adr/ADR-0002-phase3-single-shaping-owner.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_fb15bf0.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | @ Phase 3 accounting reopen + shaping closure (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `iam_v2_scratch/phase3_0010_lifecycle.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
| `scripts/pmsd-pg-integration.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 3: durable accounting, netd shaping control plane, controlled-writer boundary, guest vertical slice |
...
```text
 ...
 data-plane/cmd/acctd/phase3.go                     |  365 ++++
 data-plane/cmd/acctd/phase3_accounting.go          |  172 ++
 .../cmd/acctd/phase3_boundary_integration_test.go  |  410 ++++
 data-plane/cmd/acctd/phase3_envelope.go            |   92 +
 data-plane/cmd/acctd/phase3_envelope_test.go       |  176 ++
 .../cmd/acctd/phase3_ingest_integration_test.go    |  145 ++
 .../cmd/acctd/phase3_pass_integration_test.go      |  412 ++++
 data-plane/cmd/acctd/phase3_test.go                |  162 ++
 ...
 data-plane/cmd/netd/main.go                        |   51 +-
 ...
 data-plane/cmd/netd/phase3_shaping.go              |  442 ++++
 data-plane/cmd/netd/phase3_shaping_test.go         |  760 +++++++
 ...
 data-plane/cmd/scd/phase3_auth.go                  |  489 +++++
 data-plane/cmd/scd/phase3_auth_integration_test.go |  484 +++++
 ...
 data-plane/internal/shapeplan/plan.go              |  170 ++
 ...
 .../0010_phase3_stay_resolution.down.sql           |  178 ++
 .../migrations/0010_phase3_stay_resolution.up.sql  | 2251 ++++++++++++++++++++
 deploy/systemd/stayconnect-pmsd.service            |   41 +
 docs/PHASE3_DEPLOYMENT_AND_ROLLBACK_RUNBOOK.md     |  203 ++
 docs/PHASE3_SCOPE_AMENDMENT_PROPOSAL.md            |   98 +
...
D  exports/chatgpt/phase-evidence/GIT_STAT_12f4173.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_fb15bf0.txt
