...
- **HEAD commit:** `827240b`
- **Provenance (generation HEAD = inventory_head):** `7755bddf1f096a46140774c841fea17fb3cd9e0d`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
| `exports/chatgpt/phase-evidence/GIT_STAT_22ee4f1.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12 |
...
| `tools/generate-change-manifest.py` | MODIFIED | `M` | tests/tooling | TOOLING | rollback RESTORES prior content | (no commit subject in range) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           | 1084 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1891 +++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 296355 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111113 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42050 bytes
 .../chatgpt/phase-evidence/GIT_STAT_22ee4f1.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1095 +++++++
 ...
 374 files changed, 76696 insertions(+), 750 deletions(-)
```

## Working-tree status (`git status --short --untracked-files=all`)
```text
M  tools/generate-change-manifest.py
```

## Commits in range (`git log --oneline <base>..HEAD`)
```text
HISTORICAL: 7755bdd Phase 4: point the authoritative CI facts at run 31619644718 on head 22ee4f12
