...
- **HEAD commit:** `efdd580`
- **Provenance (generation HEAD = inventory_head):** `efdd5805eb741bddcffd8b52a2d90a6e78e772a9`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_efdd580.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4: correct Manual Review scope, evidence and role truth |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  977 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1784 ++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 294453 bytes
 ...
 .../chatgpt/phase-evidence/GIT_STAT_efdd580.txt    |    4 +
 ...
 328 files changed, 67748 insertions(+), 728 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_943705f.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_efdd580.txt
