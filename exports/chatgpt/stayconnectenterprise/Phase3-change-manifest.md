...
- **Provenance (generation HEAD = inventory_head):** `31b61d5d938052526360de3371ba88c3cd14d688`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_31b61d5.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           | 1028 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1811 ++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 295357 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111132 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42055 bytes
 .../chatgpt/phase-evidence/GIT_STAT_31b61d5.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1028 +++++++
 ...
 353 files changed, 72237 insertions(+), 729 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_31b61d5.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_3dac30e.txt
...
```text
31b61d5 Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest
