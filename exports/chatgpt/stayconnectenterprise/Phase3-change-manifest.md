...
- **HEAD commit:** `edd0e8a`
- **Provenance (generation HEAD = inventory_head):** `edd0e8a8749859e1e6230517eb2a9299abbd57a6`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_edd0e8a.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4: migration 0015 â€” 0014's payment bounds were not concurrency-safe |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  992 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1799 ++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 294758 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111137 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42050 bytes
 .../chatgpt/phase-evidence/GIT_STAT_9a1f356.txt    |    4 -
 .../chatgpt/phase-evidence/GIT_STAT_edd0e8a.txt    |    4 +
 ...
 336 files changed, 69579 insertions(+), 728 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_3f6bb8f.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_edd0e8a.txt
