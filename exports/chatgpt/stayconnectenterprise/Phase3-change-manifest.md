...
| `exports/chatgpt/phase-evidence/GIT_STAT_fb15bf0.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 3 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
```text
 ...
 193 files changed, 32600 insertions(+), 380 deletions(-)
```
