...
- **HEAD commit:** `a2e733f9cf46af0d0ea3a946d3e731a9bc708bd2`
- **Provenance (generation HEAD = inventory_head):** `a2e733f9cf46af0d0ea3a946d3e731a9bc708bd2`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_a2e733f.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | @ Phase 3 increment 3 Â§9 credential_mode NONE + Migration-0010 credential-aware pin coherence (inventory_head): truthful no-auth Protel FIAS; race-green + lifecycle-gate 121/121 + PG16-green |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           | 269 +++++++++
 ...
 .../chatgpt/phase-evidence/GIT_STAT_a2e733f.txt    |   4 +
 ...
 91 files changed, 9221 insertions(+), 272 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_a2e733f.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_b0ddce3.txt
