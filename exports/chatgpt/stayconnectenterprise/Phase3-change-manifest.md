...
- **HEAD commit:** `b9cf833`
- **Provenance (generation HEAD = inventory_head):** `b9cf8330d3511bd452931016ca6b0b1a65e13bc6`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_b9cf833.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  811 ++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1573 ++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 290195 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 107778 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42130 bytes
 .../chatgpt/phase-evidence/GIT_STAT_9a1f356.txt    |    4 -
 .../chatgpt/phase-evidence/GIT_STAT_b9cf833.txt    |    4 +
 ...
 273 files changed, 55924 insertions(+), 557 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_11411b9.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_b9cf833.txt
