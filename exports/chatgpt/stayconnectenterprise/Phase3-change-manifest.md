...
- **HEAD commit:** `1bf493694d978339efca0a1f55ba14f4606c590a`
- **Provenance (generation HEAD = inventory_head):** `1bf493694d978339efca0a1f55ba14f4606c590a`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `data-plane/internal/checkout/checkout.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 Increment-7 Checkout conversion safety + boundary corrections (inventory_head): fail-closed, boundary-eligibility, durable audit â€” PG16-green + gate 141/141 |
| `data-plane/internal/checkout/checkout_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 Increment-7 Checkout conversion safety + boundary corrections (inventory_head): fail-closed, boundary-eligibility, durable audit â€” PG16-green + gate 141/141 |
...
| `data-plane/migrations/0010_phase3_stay_resolution.down.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3 Increment-7 Checkout conversion safety + boundary corrections (inventory_head): fail-closed, boundary-eligibility, durable audit â€” PG16-green + gate 141/141 |
| `data-plane/migrations/0010_phase3_stay_resolution.up.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3 Increment-7 Checkout conversion safety + boundary corrections (inventory_head): fail-closed, boundary-eligibility, durable audit â€” PG16-green + gate 141/141 |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase-evidence/GIT_STAT_1bf4936.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | @ Phase 3 Increment-7 atomic Checkout conversion (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3 Increment-7 Checkout conversion safety + boundary corrections (inventory_head): fail-closed, boundary-eligibility, durable audit â€” PG16-green + gate 141/141 |
...
| `iam_v2_scratch/phase3_0010_lifecycle.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 3 Increment-7 Checkout conversion safety + boundary corrections (inventory_head): fail-closed, boundary-eligibility, durable audit â€” PG16-green + gate 141/141 |
...
```text
 ...
 data-plane/internal/checkout/checkout.go           | 480 ++++++++++++++
 .../internal/checkout/checkout_integration_test.go | 522 +++++++++++++++
 ...
 .../0010_phase3_stay_resolution.down.sql           |  87 +++
 .../migrations/0010_phase3_stay_resolution.up.sql  | 516 +++++++++++++++
 ...
 docs/manifests/Phase3-change-manifest.md           | 323 +++++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |   4 +-
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip | Bin 250675 -> 274908 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  | Bin 101471 -> 103267 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip | Bin 41921 -> 42004 bytes
 .../chatgpt/phase-evidence/GIT_STAT_1bf4936.txt    |   4 +
 ...
 iam_v2_scratch/phase3_0010_lifecycle.sh            | 333 ++++++++++
 ...
 105 files changed, 12859 insertions(+), 272 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_1bf4936.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_2c0df80.txt
