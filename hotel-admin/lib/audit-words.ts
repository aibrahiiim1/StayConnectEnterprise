...
const WORDS: Record<string, AuditWords> = {
  ...
  "cloud.refresh_license": { title: "Refreshed the licence from StayConnect", category: "Licence & cloud", severity: "notice" },
  "cloud.test_connection": { title: "Tested the StayConnect connection", category: "Licence & cloud", severity: "notice" },
