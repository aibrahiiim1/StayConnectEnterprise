...
export const PORTAL_STRINGS: { group: string; key: string; english: string }[] = [
  ...
  { group: "Sign-in page", key: "brand.fallback", english: "Guest Wi-Fi" },
  { group: "Device info", key: "info.button", english: "Device information" },
  ...
  { group: "Messages", key: "err.room.technical", english: "We are unable to verify your stay right now. Please try again or contact Reception." },
  ...
  { group: "Messages", key: "err.voucher.empty", english: "Please enter a voucher code." },
  { group: "Messages", key: "err.voucher.invalid", english: "That voucher code didn't work. Check the code and try again." },
  { group: "Messages", key: "err.voucher.devices", english: "This voucher has reached its device limit. Disconnect another device and try again." },
  ...
  { group: "Messages", key: "err.service", english: "Something went wrong. Please try again." },
  { group: "Messages", key: "err.packages.off", english: "Internet packages are not available right now. Please ask reception." },
  { group: "Messages", key: "err.packages.none", english: "No internet packages are available for you right now." },
  ...
  { group: "Units", key: "unit.d", english: "{n} d" },
  ...
  { group: "You're online", key: "tl.none", english: "No time" },
  { group: "Your devices", key: "dev.title", english: "Your devices" },
  { group: "Your devices", key: "dev.lead", english: "These are the devices using your internet access. Removing one frees its place for another device — nothing about your access changes, and the removed device can connect again at any time." },
  { group: "Your devices", key: "dev.name", english: "Device {n}" },
  { group: "Your devices", key: "dev.online", english: "Connected now" },
  { group: "Your devices", key: "dev.offline", english: "Not connected" },
  { group: "Your devices", key: "dev.lastused", english: "Last used: {t}" },
  { group: "Your devices", key: "dev.justnow", english: "just now" },
  { group: "Your devices", key: "dev.ago", english: "{t} ago" },
  { group: "Your devices", key: "dev.remove", english: "Remove this device" },
  { group: "Your devices", key: "dev.confirm", english: "Remove device {n}? It will lose its place, and can connect again at any time." },
  { group: "Your devices", key: "dev.yes", english: "Remove" },
  { group: "Your devices", key: "dev.keep", english: "Keep" },
  { group: "Your devices", key: "dev.inuse", english: "In use right now, so it can’t be removed. Disconnect it from the Wi‑Fi first." },
  { group: "Your devices", key: "dev.cannot", english: "This device can’t be removed right now." },
