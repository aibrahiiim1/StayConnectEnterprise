...
- **Base commit:** `865443f5f4dd03c0700dab5bb43b135cfecc1289`
- **HEAD commit:** `c01f87bf73104a975c168b39d254e19af2c10705`
- **Provenance (generation HEAD = inventory_head):** `c01f87bf73104a975c168b39d254e19af2c10705`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
- **Branch:** `post-closure/hotel-admin-ui-prelive-governance`
- **Remote branch:** `(no upstream)`
- **Changed files:** 13
- **Generated by:** `tools/generate-change-manifest.py 865443f5f4dd..STAGED`
...
| `exports/chatgpt/phase-evidence/GIT_STAT_614de5c6.txt` | EXPORTED | `D` | export | EXPORT | rollback RESTORES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/GIT_STAT_c01f87bf.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | PC-0006 deployed to PRE-LIVE and accepted live: record what is actually running |

## Total diff statistics (`git diff --stat`)
```text
 docs/manifests/PostClosure-change-manifest.md      | 1495 +-------------------
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 332526 -> 332526 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 139898 -> 139905 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 43734 -> 43735 bytes
 ...
 governance/project-state.json                      |   45 +-
 13 files changed, 110 insertions(+), 1512 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_614de5c6.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_c01f87bf.txt
...
```text
HISTORICAL: c01f87bf PC-0006 deployed to PRE-LIVE and accepted live: record what is actually running
```
