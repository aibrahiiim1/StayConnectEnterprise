...
- **Base commit:** `37652b65ffba80b8ec4fb4c75adb9aa175ac5be1`
- **HEAD commit:** `f2298560`
- **Provenance (generation HEAD = inventory_head):** `f229856064c618e3cf6c0051eb578f817218321f`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
- **Branch:** `gov/t0145-room-reuse-deployed`
- **Remote branch:** `(no upstream)`
- **Changed files:** 25
- **Generated by:** `tools/generate-change-manifest.py 37652b65ffba..STAGED`

## Files

| Path | Classification | Git status | Domain | Workstream | Rollback | Purpose (last commit subject in range) |
|---|---|---|---|---|---|---|
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Governance: T0145 records the effective-policy surface deployed and verified |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Governance: T0145 records the effective-policy surface deployed and verified |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Governance: T0145 records the effective-policy surface deployed and verified |
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Governance: T0145 records the effective-policy surface deployed and verified |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_d98da735.txt` | EXPORTED | `D` | export | EXPORT | rollback RESTORES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/GIT_STAT_f2298560.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Governance: T0145 records the effective-policy surface deployed and verified |
...
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Governance: T0145 records the effective-policy surface deployed and verified |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Governance: T0145 records the effective-policy surface deployed and verified |
| `governance/transitions/T0145.json` | CREATED | `A` | governance | GOVERNANCE | rollback REMOVES it | Governance: T0145 records the effective-policy surface deployed and verified |
...
```text
 ...
 docs/manifests/PostClosure-change-manifest.md      |  95 +++++++++------------
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip | Bin 340190 -> 340199 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  | Bin 140442 -> 140436 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip | Bin 43885 -> 43884 bytes
 ...
 .../StayConnect-IAM-Phase1B-Plan.md                |   4 +-
 governance/project-state.json                      |  18 ++--
 governance/transitions/T0145.json                  |  53 ++++++++++++
 25 files changed, 168 insertions(+), 132 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_d98da735.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_f2298560.txt
...
```text
HISTORICAL: f2298560 Governance: T0145 records the effective-policy surface deployed and verified
```
