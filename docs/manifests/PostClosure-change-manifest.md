...
- **Provenance (generation HEAD = inventory_head):** `94a4bb3d29e5fabcf021d4cd8333e8923c9a9d2e`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_94a4bb3d.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/GIT_STAT_b2127657.txt` | EXPORTED | `D` | export | EXPORT | rollback RESTORES it | (no commit subject in range) |
...
| `governance/transitions/T0152.json` | CREATED | `A` | governance | GOVERNANCE | rollback REMOVES it | (no commit subject in range) |
...
A  exports/chatgpt/phase-evidence/GIT_STAT_94a4bb3d.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_b2127657.txt
...
A  governance/transitions/T0152.json
```
