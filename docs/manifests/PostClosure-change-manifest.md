...
- **Provenance (generation HEAD = inventory_head):** `b2127657ef9d534f3350bb3e3220a2c62b8554f5`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
- **Branch:** `master`
...
| `exports/chatgpt/phase-evidence/GIT_STAT_7a9ba699.txt` | EXPORTED | `D` | export | EXPORT | rollback RESTORES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/GIT_STAT_b2127657.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/transitions/T0151.json` | CREATED | `A` | governance | GOVERNANCE | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 27 files changed, 232 insertions(+), 91 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_7a9ba699.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_b2127657.txt
...
A  governance/transitions/T0151.json
```
