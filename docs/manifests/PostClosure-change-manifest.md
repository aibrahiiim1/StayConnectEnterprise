...
- **Provenance (generation HEAD = inventory_head):** `7d4e79471fa5801a8e1b41d4a3c6a7ab68c5a67d`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_7d4e7947.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/GIT_STAT_9078467d.txt` | EXPORTED | `D` | export | EXPORT | rollback RESTORES it | (no commit subject in range) |
...
```text
 ...
 31 files changed, 442 insertions(+), 126 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_7d4e7947.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_9078467d.txt
