...
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1A-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Delivery: export packs rebuilt for T0124 |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Delivery: export packs rebuilt for T0124 |
...
| `governance/transitions/T0124.json` | CREATED | `A` | governance | GOVERNANCE | rollback REMOVES it | Governance: T0124 must precede the commit that carries it |
