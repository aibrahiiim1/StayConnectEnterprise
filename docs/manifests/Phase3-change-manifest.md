...
- **HEAD commit:** `12f417345294c71a34c4d2b642348fd86866d530`
- **Provenance (generation HEAD = inventory_head):** `12f417345294c71a34c4d2b642348fd86866d530`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `data-plane/cmd/acctd/main.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
| `data-plane/cmd/acctd/phase3.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
| `data-plane/cmd/acctd/phase3_accounting.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
| `data-plane/cmd/acctd/phase3_ingest_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 correction item 7 (inventory_head): controlled Phase-3 accounting ingestion wired into acctd with 11 composition-root cases |
| `data-plane/cmd/acctd/phase3_pass_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
| `data-plane/cmd/acctd/phase3_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
...
| `data-plane/cmd/netd/main.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
| `data-plane/cmd/netd/phase3_shaping.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
| `data-plane/cmd/netd/phase3_shaping_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
| `data-plane/cmd/pmsd/main.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 correction item 1 (inventory_head): pmsd Stay-Event application worker composition root + process-level tests |
...
| `data-plane/migrations/0010_phase3_stay_resolution.down.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3 correction item 7 (inventory_head): controlled Phase-3 accounting ingestion wired into acctd with 11 composition-root cases |
| `data-plane/migrations/0010_phase3_stay_resolution.up.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3 correction item 7 (inventory_head): controlled Phase-3 accounting ingestion wired into acctd with 11 composition-root cases |
...
| `docs/architecture/adr/ADR-0002-phase3-single-shaping-owner.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 correction item 8 (inventory_head): ADR-0002 single shaping owner - netd applies, acctd derives and submits; structural preflight check |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 final report (inventory_head): 17-section dark acceptance candidate report, live Increment-9 evidence recorded PENDING |
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase-evidence/GIT_STAT_12f4173.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | @ Phase 3 correction item 8 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3 accounting item 6 reopen corrected + shaping 7-8 closed (inventory_head): right session domain, restart-durable sample identity, wiring-level tests, truthful shaping health, legacy loop stands down |
...
| `iam_v2_scratch/phase3_0010_lifecycle.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 3 corrections round 2 items 1-4 (inventory_head): mandatory grace package, ONE shared exact validator, typed package selector, mandatory DB-level preconditions: gate 320/320 |
...
| `scripts/phase3-preflight.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 3 correction item 8 (inventory_head): ADR-0002 single shaping owner - netd applies, acctd derives and submits; structural preflight check |
| `scripts/pmsd-pg-integration.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 3 correction item 7 (inventory_head): controlled Phase-3 accounting ingestion wired into acctd with 11 composition-root cases |
...
```text
 ...
 .gitignore                                         |    5 +
 data-plane/cmd/acctd/main.go                       |   40 +-
 data-plane/cmd/acctd/phase3.go                     |  247 +++
 data-plane/cmd/acctd/phase3_accounting.go          |  173 ++
 .../cmd/acctd/phase3_ingest_integration_test.go    |  414 ++++
 .../cmd/acctd/phase3_pass_integration_test.go      |  220 ++
 data-plane/cmd/acctd/phase3_test.go                |  123 ++
 ...
 data-plane/cmd/netd/main.go                        |   15 +-
 data-plane/cmd/netd/phase3_shaping.go              |  152 ++
 data-plane/cmd/netd/phase3_shaping_test.go         |  263 +++
 data-plane/cmd/pmsd/main.go                        |  132 ++
 ...
 .../0010_phase3_stay_resolution.down.sql           |  167 ++
 .../migrations/0010_phase3_stay_resolution.up.sql  | 2117 ++++++++++++++++++++
 ...
 .../adr/ADR-0002-phase3-single-shaping-owner.md    |   75 +
 docs/context/StayConnect-IAM-Handoff.md            |   16 +-
 .../StayConnect-IAM-Phase3-Schema-Gap-Audit.md     |  109 +
 docs/manifests/Phase3-change-manifest.md           |  513 +++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md |  764 +++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 280249 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 103270 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42000 bytes
 .../chatgpt/phase-evidence/GIT_STAT_12f4173.txt    |    4 +
 ...
 iam_v2_scratch/phase3_0010_lifecycle.sh            |  883 ++++++++
 scripts/edge-migrate.sh                            |  251 +++
 scripts/phase3-evidence.sh                         |   98 +
 scripts/phase3-preflight.sh                        |  140 ++
 ...
 166 files changed, 26157 insertions(+), 362 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_12f4173.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_7dc27e8.txt
