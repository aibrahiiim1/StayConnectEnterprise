...
| `exports/chatgpt/phase-evidence/GIT_STAT_7dc27e8.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 164 files changed, 25697 insertions(+), 373 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_7dc27e8.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_de24d2c.txt
