...
| `exports/chatgpt/phase-evidence/GIT_STAT_d68ec4d.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  571 +++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md |  837 +++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 281228 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 104103 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 41999 bytes
 .../chatgpt/phase-evidence/GIT_STAT_9a1f356.txt    |    4 -
 .../chatgpt/phase-evidence/GIT_STAT_d68ec4d.txt    |    4 +
 ...
 198 files changed, 34175 insertions(+), 398 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_51bafc0.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_d68ec4d.txt
