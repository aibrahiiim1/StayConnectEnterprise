...
- **HEAD commit:** `8ebce2c5cbc0f8e6baaffa05c88a3eb9861f0364`
- **Provenance (generation HEAD = inventory_head):** `8ebce2c5cbc0f8e6baaffa05c88a3eb9861f0364`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `data-plane/cmd/acctd/main.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 3 correction item 4 (inventory_head): enforce composed into acctd (true-time expiry + derived shaping reconciliation) with composition-root tests |
| `data-plane/cmd/acctd/phase3.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 correction item 4 (inventory_head): enforce composed into acctd (true-time expiry + derived shaping reconciliation) with composition-root tests |
| `data-plane/cmd/acctd/phase3_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 correction item 4 (inventory_head): enforce composed into acctd (true-time expiry + derived shaping reconciliation) with composition-root tests |
...
| `data-plane/cmd/edged/resources_phase3.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 corrections round 2 items 1-4 (inventory_head): mandatory grace package, ONE shared exact validator, typed package selector, mandatory DB-level preconditions: gate 320/320 |
...
| `data-plane/internal/checkout/checkout_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 corrections round 1 (inventory_head): controlled alert lifecycle + governed grace publication + NOT VALID boundary CHECK; real API+PG contract tests: gate 310/310 |
...
| `data-plane/internal/enforce/enforce.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 correction item 4 (inventory_head): enforce composed into acctd (true-time expiry + derived shaping reconciliation) with composition-root tests |
...
| `data-plane/internal/pmsd/applier_supervisor.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 corrections round 2 items 5-6 (inventory_head): synchronous fail-closed applier construction + supervised interface reconciliation |
| `data-plane/internal/pmsd/applier_supervisor_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 corrections round 2 items 5-6 (inventory_head): synchronous fail-closed applier construction + supervised interface reconciliation |
...
| `data-plane/migrations/0010_phase3_stay_resolution.down.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3 corrections round 2 items 1-4 (inventory_head): mandatory grace package, ONE shared exact validator, typed package selector, mandatory DB-level preconditions: gate 320/320 |
| `data-plane/migrations/0010_phase3_stay_resolution.up.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3 corrections round 2 items 1-4 (inventory_head): mandatory grace package, ONE shared exact validator, typed package selector, mandatory DB-level preconditions: gate 320/320 |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase-evidence/GIT_STAT_8ebce2c.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | @ Phase 3 corrections round 2 items 1-4 (delivery_head): complete staged manifest + rebuilt packs + pointer |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3 corrections round 2 items 5-6 (inventory_head): synchronous fail-closed applier construction + supervised interface reconciliation |
...
| `hotel-admin/components/phase3/checkout-grace-form.tsx` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 corrections round 2 items 1-4 (inventory_head): mandatory grace package, ONE shared exact validator, typed package selector, mandatory DB-level preconditions: gate 320/320 |
...
| `hotel-admin/e2e/phase3-stays-grace.spec.ts` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 corrections round 2 items 1-4 (inventory_head): mandatory grace package, ONE shared exact validator, typed package selector, mandatory DB-level preconditions: gate 320/320 |
| `hotel-admin/lib/api.ts` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 3 corrections round 2 items 1-4 (inventory_head): mandatory grace package, ONE shared exact validator, typed package selector, mandatory DB-level preconditions: gate 320/320 |
...
| `hotel-admin/test/phase3-pages.test.tsx` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 corrections round 2 items 1-4 (inventory_head): mandatory grace package, ONE shared exact validator, typed package selector, mandatory DB-level preconditions: gate 320/320 |
...
| `scripts/pmsd-pg-integration.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 3 corrections round 1 (inventory_head): controlled alert lifecycle + governed grace publication + NOT VALID boundary CHECK; real API+PG contract tests: gate 310/310 |
...
```text
 ...
 .gitignore                                         |    5 +
 data-plane/cmd/acctd/main.go                       |   20 +-
 data-plane/cmd/acctd/phase3.go                     |  143 ++
 data-plane/cmd/acctd/phase3_test.go                |  142 ++
 ...
 data-plane/cmd/edged/resources_phase3.go           |  592 ++++++
 ...
 data-plane/internal/enforce/enforce.go             |  183 ++
 ...
 data-plane/internal/pmsd/applier_supervisor.go     |  110 ++
 .../internal/pmsd/applier_supervisor_test.go       |  215 +++
 ...
 .../0010_phase3_stay_resolution.down.sql           |  164 ++
 .../migrations/0010_phase3_stay_resolution.up.sql  | 1959 ++++++++++++++++++++
 ...
 docs/manifests/Phase3-change-manifest.md           |  489 +++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md |  764 ++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 279590 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 103226 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 41999 bytes
 .../chatgpt/phase-evidence/GIT_STAT_8ebce2c.txt    |    4 +
 ...
 158 files changed, 24037 insertions(+), 360 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_8ebce2c.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_f322c84.txt
