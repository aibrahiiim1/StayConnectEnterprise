...
| `exports/chatgpt/phase-evidence/GIT_STAT_d0f57e0.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  395 +++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 277306 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 103274 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 41999 bytes
 .../chatgpt/phase-evidence/GIT_STAT_9a1f356.txt    |    4 -
 .../chatgpt/phase-evidence/GIT_STAT_d0f57e0.txt    |    4 +
 ...
 122 files changed, 17815 insertions(+), 354 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_0927baa.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_d0f57e0.txt
