...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  654 +++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1083 ++++++++
 ...
 225 files changed, 41780 insertions(+), 458 deletions(-)
```
...
MM governance/decision-register.json
