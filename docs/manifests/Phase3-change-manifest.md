...
- **HEAD commit:** `51bafc0d81b6a8f9623d2037012c625744a66821`
- **Provenance (generation HEAD = inventory_head):** `51bafc0d81b6a8f9623d2037012c625744a66821`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `data-plane/cmd/acctd/phase3.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 (D15 / Option C): accounting attribution, source binding, temporal order, class origin, generation authority |
| `data-plane/cmd/acctd/phase3_accounting.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 (D15 / Option C): accounting attribution, source binding, temporal order, class origin, generation authority |
...
| `data-plane/cmd/netd/phase3_shaping.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3 (D15 / Option C): accounting attribution, source binding, temporal order, class origin, generation authority |
| `data-plane/cmd/netd/phase3_shaping_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 (D15 / Option C): accounting attribution, source binding, temporal order, class origin, generation authority |
...
| `data-plane/migrations/0010_phase3_stay_resolution.down.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3 (D15 / Option C): accounting attribution, source binding, temporal order, class origin, generation authority |
| `data-plane/migrations/0010_phase3_stay_resolution.up.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3 (D15 / Option C): accounting attribution, source binding, temporal order, class origin, generation authority |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_51bafc0.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 data-plane/cmd/acctd/phase3_accounting.go          |  182 ++
 ...
 data-plane/cmd/netd/phase3_shaping.go              |  506 ++++
 data-plane/cmd/netd/phase3_shaping_test.go         | 1040 ++++++++
 ...
 .../0010_phase3_stay_resolution.down.sql           |  186 ++
 .../migrations/0010_phase3_stay_resolution.up.sql  | 2486 ++++++++++++++++++++
 ...
 docs/manifests/Phase3-change-manifest.md           |  559 +++++
 ...
 193 files changed, 32603 insertions(+), 381 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_51bafc0.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_fb15bf0.txt
