...
| `exports/chatgpt/phase-evidence/GIT_STAT_e42f1cd.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  630 +++++
 ...
 220 files changed, 40036 insertions(+), 464 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_4184bf3.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_e42f1cd.txt
