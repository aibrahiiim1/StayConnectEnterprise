...
| `exports/chatgpt/phase-evidence/GIT_STAT_b8aeca1.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 109 files changed, 16532 insertions(+), 284 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_b8aeca1.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_d976419.txt
