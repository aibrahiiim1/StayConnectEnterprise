...
| `exports/chatgpt/phase-evidence/GIT_STAT_4eb9768.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 155 files changed, 23232 insertions(+), 360 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_4eb9768.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_86bda6b.txt
