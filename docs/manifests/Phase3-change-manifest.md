...
| `exports/chatgpt/phase-evidence/GIT_STAT_c018f84.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 107 files changed, 15168 insertions(+), 284 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_362aecd.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_c018f84.txt
