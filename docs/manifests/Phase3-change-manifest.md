...
| `exports/chatgpt/phase-evidence/GIT_STAT_82330dc.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           | 139 ++++++++++++++
 ...
 54 files changed, 1731 insertions(+), 209 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_82330dc.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_b08b6cc.txt
