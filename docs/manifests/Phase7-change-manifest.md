...
|---|---|---|---|---|---|---|
| `.github/workflows/phase3-software.yml` | MODIFIED | `M` | configuration | CI | rollback RESTORES prior content | Key the guest-authority lock on the production build, not on a caller argument |
...
| `data-plane/internal/iamv2/build_profile_development.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Key the guest-authority lock on the production build, not on a caller argument |
| `data-plane/internal/iamv2/build_profile_production.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Key the guest-authority lock on the production build, not on a caller argument |
...
| `data-plane/internal/iamv2/concurrency_test.go` | MODIFIED | `M` | tests/tooling | RUNTIME | rollback RESTORES prior content | Key the guest-authority lock on the production build, not on a caller argument |
| `data-plane/internal/iamv2/config_env.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Key the guest-authority lock on the production build, not on a caller argument |
...
| `data-plane/internal/iamv2/guest_authority_e2e_development_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Key the guest-authority lock on the production build, not on a caller argument |
| `data-plane/internal/iamv2/guest_authority_e2e_production_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Key the guest-authority lock on the production build, not on a caller argument |
| `data-plane/internal/iamv2/guest_authority_lock.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Key the guest-authority lock on the production build, not on a caller argument |
| `data-plane/internal/iamv2/guest_authority_lock_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Key the guest-authority lock on the production build, not on a caller argument |
...
```text
 .github/workflows/phase3-software.yml              |  10 +
 .gitignore                                         |   1 +
 ...
 data-plane/internal/iamv2/concurrency_test.go      |  51 +-
 data-plane/internal/iamv2/config_env.go            |  15 +
 ...
 .../iamv2/guest_authority_e2e_development_test.go  |  22 +
 .../iamv2/guest_authority_e2e_production_test.go   |  30 +
 data-plane/internal/iamv2/guest_authority_lock.go  | 106 ++++
 .../internal/iamv2/guest_authority_lock_test.go    | 121 ++++
 ...
 governance/transitions/T0078.json                  |  51 ++
