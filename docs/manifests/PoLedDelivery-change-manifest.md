...
- **Provenance (generation HEAD = inventory_head):** `53cfb3e8e2d51153a6ae24674f885355f755a48f`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/manifests/PoLedDelivery-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Change manifest for the D42 migration |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_53cfb3e8.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
```text
 ...
 docs/manifests/PoLedDelivery-change-manifest.md    | 162 +++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip | Bin 343170 -> 343230 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  | Bin 149846 -> 151099 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip | Bin 44026 -> 44009 bytes
 .../chatgpt/phase-evidence/GIT_STAT_53cfb3e8.txt   |   4 +
 ...
 56 files changed, 1178 insertions(+), 2407 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_53cfb3e8.txt
