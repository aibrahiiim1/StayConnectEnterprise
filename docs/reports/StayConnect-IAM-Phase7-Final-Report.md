...
- **HEAD commit:** `55369df2676db6081b3cec389c92a1d5455983f3`
- **Provenance (generation HEAD = inventory_head):** `55369df2676db6081b3cec389c92a1d5455983f3`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/manifests/Phase7-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
| `docs/reports/StayConnect-IAM-Phase7-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
| `exports/chatgpt/phase-evidence/GIT_STAT_55369df.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | DEVELOPMENT trial round (delivery_head): manifest, packs and checksums |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Correct the D31/T0067 attribution, and make that class fail Governance |
...
| `tools/validate-current-state-parity.py` | MODIFIED | `M` | tests/tooling | TOOLING | rollback RESTORES prior content | Correct the D31/T0067 attribution, and make that class fail Governance |
...
```text
 ...
 docs/manifests/Phase7-change-manifest.md           |   249 +
 .../reports/StayConnect-IAM-Phase7-Final-Report.md |   486 +
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |   Bin 312530 -> 313279 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |   Bin 118948 -> 123167 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |   Bin 42195 -> 42146 bytes
 .../chatgpt/phase-evidence/GIT_STAT_55369df.txt    |     4 +
 ...
 tools/validate-current-state-parity.py             |   398 +
 tools/validate-project-state.sh                    |     2 +-
 71 files changed, 20688 insertions(+), 193 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_38890f5.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_55369df.txt
