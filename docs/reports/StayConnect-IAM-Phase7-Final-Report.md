...
- **HEAD commit:** `39a322a621a2a550a68a2e10562f8a8e2b0dc490`
- **Provenance (generation HEAD = inventory_head):** `39a322a621a2a550a68a2e10562f8a8e2b0dc490`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/manifests/Phase7-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Trial-blocker round (delivery_head): manifest, packs and checksums |
| `docs/reports/StayConnect-IAM-Phase7-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Trial-blocker round (delivery_head): manifest, packs and checksums |
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/phase-evidence/GIT_STAT_39a322a.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/phase-evidence/governance/decision-register.json` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/phase-evidence/tools/validate-project-state.sh` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/phase1b-planning/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
...
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Handoff.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase0-Contract.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1A-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | D31/T0068: correct D30 scope, and make the edged writer grant reproducible |
...
| `governance/transitions/T0067.json` | CREATED | `A` | governance | GOVERNANCE | rollback REMOVES it | Clean IAM-v2 replacement (D30/T0067): wire the repositories the accepted phases already built |
...
```text
 ...
 docs/manifests/Phase7-change-manifest.md           |   228 +
 .../reports/StayConnect-IAM-Phase7-Final-Report.md |   465 +
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |   Bin 312530 -> 313278 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |   Bin 118948 -> 123165 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |   Bin 42195 -> 42144 bytes
 .../chatgpt/phase-evidence/GIT_STAT_39a322a.txt    |     4 +
 ...
 71 files changed, 20541 insertions(+), 193 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_39a322a.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_d0e3904.txt
