...
- **HEAD commit:** `827240b`
- **Provenance (generation HEAD = inventory_head):** `b8ba3b6926df125c9266d629a69061f6b1718480`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `.github/workflows/phase4-financial-core.yml` | CREATED | `A` | configuration | CI | rollback REMOVES it | Phase 4: financial-ops API contract tests, extended DARK and authoritative CI, Plan sync |
...
| `data-plane/internal/iamv2/commerce_settled_grant.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: close the payment backend boundary (0018) â€” resolved financial identity, trusted notification boundary, NOT_SENT preflight, operational least privilege |
...
| `data-plane/internal/payment/engine.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface |
...
| `data-plane/internal/payment/granter.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
...
| `data-plane/internal/payment/pg_grant_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: close the payment backend boundary (0018) â€” resolved financial identity, trusted notification boundary, NOT_SENT preflight, operational least privilege |
| `data-plane/internal/payment/pg_health_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface |
| `data-plane/internal/payment/pg_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: close the payment backend boundary (0018) â€” resolved financial identity, trusted notification boundary, NOT_SENT preflight, operational least privilege |
| `data-plane/internal/payment/pg_recovery_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface |
| `data-plane/internal/payment/pg_restricted_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: close the payment backend boundary (0018) â€” resolved financial identity, trusted notification boundary, NOT_SENT preflight, operational least privilege |
...
| `data-plane/internal/payment/recovery.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: financial-ops API contract tests, extended DARK and authoritative CI, Plan sync |
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `docs/architecture/StayConnect-IAM-Phase4-Plan.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: financial-ops API contract tests, extended DARK and authoritative CI, Plan sync |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_b8ba3b6.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
| `exports/chatgpt/phase1b-planning/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2 |
...
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Handoff.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase0-Contract.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1A-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4 (delivery_head): T0038 receipt + project-state pointers |
...
| `hotel-admin/components/nav.tsx` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface |
...
| `hotel-admin/e2e/phase4-financial-operator.spec.ts` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface |
| `hotel-admin/lib/api.ts` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface |
...
| `iam_v2_scratch/phase4_0011_financial.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: close the payment backend boundary (0018) â€” resolved financial identity, trusted notification boundary, NOT_SENT preflight, operational least privilege |
...
| `scripts/phase4-least-privilege.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface |
| `scripts/phase4-payment-concurrency.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface |
| `scripts/phase4-pg-integration.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: financial-ops API contract tests, extended DARK and authoritative CI, Plan sync |
...
```text
 ...
 .github/workflows/phase4-financial-core.yml        |  185 ++
 ...
 .../internal/iamv2/commerce_settled_grant.go       |  134 +
 ...
 data-plane/internal/payment/engine.go              |  498 ++++
 data-plane/internal/payment/export_test.go         |   15 +
 data-plane/internal/payment/granter.go             |   29 +
 data-plane/internal/payment/health.go              |  256 ++
 data-plane/internal/payment/payment.go             |  227 ++
 .../internal/payment/pg_grant_integration_test.go  |  200 ++
 .../internal/payment/pg_health_integration_test.go |  128 +
 data-plane/internal/payment/pg_integration_test.go |  593 ++++
 .../payment/pg_recovery_integration_test.go        |  285 ++
 .../payment/pg_restricted_integration_test.go      |  211 ++
 data-plane/internal/payment/provider.go            |   93 +
 data-plane/internal/payment/recovery.go            |  168 ++
 ...
 docs/architecture/StayConnect-IAM-Phase4-Plan.md   |  206 ++
 ...
 .../chatgpt/phase-evidence/GIT_STAT_b8ba3b6.txt    |    4 +
 ...
 hotel-admin/e2e/phase4-financial-operator.spec.ts  |  181 ++
 hotel-admin/lib/api.ts                             |  199 ++
 ...
 iam_v2_scratch/phase4_0011_financial.sh            |  700 +++++
 ...
 scripts/phase4-least-privilege.sh                  |   30 +
 scripts/phase4-payment-concurrency.sh              |   31 +
 scripts/phase4-pg-integration.sh                   |  130 +
 ...
 373 files changed, 76543 insertions(+), 749 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_1d20ecd.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_b8ba3b6.txt
...
```text
b8ba3b6 Phase 4 (delivery_head): T0038 receipt + project-state pointers
827240b Phase 4: financial-ops API contract tests, extended DARK and authoritative CI, Plan sync
806b4f8 Phase 4: FINANCIAL_RECOVERY_MODE (0019), observability (0020), financial-ops API and the Hotel-Admin operator surface
7b10ec3 Phase 4: close the payment backend boundary (0018) â€” resolved financial identity, trusted notification boundary, NOT_SENT preflight, operational least privilege
7d427c4 Phase 4: point the authoritative CI facts at run 31601463842 on head 1d20ecd2
...
d3afa65 Phase 4 (delivery_head): manifest + rebuilt packs + pointer
7560dd0 Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014)
3a87b79 Phase 4 (delivery_head): manifest + rebuilt packs + pointer
efdd580 Phase 4: correct Manual Review scope, evidence and role truth
3e2eb20 Phase 4 (delivery_head): manifest + rebuilt packs + pointer
943705f Phase 4: record the authoritative CI evidence for software candidate 82ce2d6
d853fe4 Phase 4 (delivery_head): manifest + rebuilt packs + pointer
82ce2d6 Phase 4: close the construction boundary for real, and deliver the Manual Review operator surface
1f65a63 Phase 4 (delivery_head): manifest + rebuilt packs + pointer
8beed1e Phase 4: record the authoritative CI evidence for delivery head 0aa63d77
0aa63d7 Phase 4 (delivery_head): manifest + rebuilt packs + pointer
4ce51dc Phase 4: close the production construction boundary and correct the reversal model to the FINAL contract
102a75c Phase 4 (delivery_head): manifest + rebuilt packs + pointer
6361f07 Phase 4: record the authoritative CI evidence for head f9f13f97
f9f13f9 Phase 4 (delivery_head): manifest + rebuilt packs + pointer
...
7202152 Phase 4 audit (delivery_head): manifest + rebuilt packs + pointer
