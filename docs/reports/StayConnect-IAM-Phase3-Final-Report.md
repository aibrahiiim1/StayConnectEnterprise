...
- **HEAD commit:** `0aa361a`
- **Provenance (generation HEAD = inventory_head):** `0aa361ad2c8dfc278c7c0fde8afe9f6dba167b29`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `data-plane/cmd/edged/resources_phase5_transfer.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
| `data-plane/internal/transfer/transfer.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
| `docs/evidence/StayConnect-IAM-Phase5-Evidence.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 (delivery_head): M2 fix-forward pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 (delivery_head): M2 fix-forward pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
| `exports/chatgpt/phase-evidence/GIT_STAT_0aa361a.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 5 M3: Cross-PMS Transfer â€” typed, staff-confirmed, never inferred |
...
```text
 ...
 data-plane/cmd/edged/resources_phase5_transfer.go  |  250 ++
 ...
 data-plane/internal/transfer/transfer.go           |  377 +++
 ...
 docs/evidence/StayConnect-IAM-Phase5-Evidence.md   |  185 ++
 docs/evidence/phase4/npm-audit-full.json           |   22 +
 docs/evidence/phase4/npm-audit-production.json     |   22 +
 docs/manifests/Phase3-change-manifest.md           | 1323 ++++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 2130 +++++++++++++
 .../reports/StayConnect-IAM-Phase4-Final-Report.md |  159 +
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 304413 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 114431 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42080 bytes
 .../chatgpt/phase-evidence/GIT_STAT_0aa361a.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1323 ++++++++
 ...
 governance/project-state.json                      |  529 +++-
 ...
 466 files changed, 99099 insertions(+), 2245 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_0aa361a.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_dead716.txt
