...
- **HEAD commit:** `553d166`
- **Provenance (generation HEAD = inventory_head):** `553d166c9c3e61f2ac81525e29684b87d118e58b`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `data-plane/internal/nft/nft_phase3_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3 pre-live safety (inventory_head): bounded kernel lease, fail-closed activation, DB-verified accountability, surgical nft foundation, real-kernel gate |
| `data-plane/internal/nft/parse.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 3 pre-live safety (inventory_head): bounded kernel lease, fail-closed activation, DB-verified accountability, surgical nft foundation, real-kernel gate |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 pre-live safety (inventory_head): bounded kernel lease, fail-closed activation, DB-verified accountability, surgical nft foundation, real-kernel gate |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_553d166.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3 pre-live safety (inventory_head): bounded kernel lease, fail-closed activation, DB-verified accountability, surgical nft foundation, real-kernel gate |
...
| `scripts/ci/kernel-netns-suite.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 3 pre-live safety (inventory_head): bounded kernel lease, fail-closed activation, DB-verified accountability, surgical nft foundation, real-kernel gate |
...
```text
 ...
 data-plane/internal/nft/nft_phase3_test.go         |  369 +++
 data-plane/internal/nft/parse.go                   |    9 +
 ...
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1237 ++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 285920 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 105423 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42094 bytes
 .../chatgpt/phase-evidence/GIT_STAT_553d166.txt    |    4 +
 ...
 governance/decision-register.json                  |   19 +-
 governance/project-state.json                      |  196 +-
 ...
 scripts/ci/kernel-netns-suite.sh                   |  218 ++
 ...
 243 files changed, 48016 insertions(+), 512 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_17c9f4c.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_553d166.txt
