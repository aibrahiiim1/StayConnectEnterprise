...
- **HEAD commit:** `b1caebb`
- **Provenance (generation HEAD = inventory_head):** `b1caebbe037d6c6e6c6e5564751c5813bb546ed5`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 pre-live (inventory_head): hard-boundary lease precision, durable activation bound, and a Zero-Stale check that had never run |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_b1caebb.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3 pre-live (inventory_head): hard-boundary lease precision, durable activation bound, and a Zero-Stale check that had never run |
...
| `governance/transitions/T0018.json` | CREATED | `A` | governance | GOVERNANCE | rollback REMOVES it | (no commit subject in range) |
...
| `tools/validate-project-state.sh` | MODIFIED | `M` | tests/tooling | TOOLING | rollback RESTORES prior content | Phase 3 pre-live (inventory_head): hard-boundary lease precision, durable activation bound, and a Zero-Stale check that had never run |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  733 +++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1301 +++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 286093 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 107199 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42089 bytes
 .../chatgpt/phase-evidence/GIT_STAT_9a1f356.txt    |    4 -
 .../chatgpt/phase-evidence/GIT_STAT_b1caebb.txt    |    4 +
 ...
 .../phase-evidence/tools/validate-project-state.sh |  128 +-
 ...
 governance/decision-register.json                  |   19 +-
 governance/project-state.json                      |   80 +-
 ...
 tools/validate-project-state.sh                    |  128 +-
 245 files changed, 49085 insertions(+), 498 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_1520492.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_b1caebb.txt
...
A  governance/transitions/T0018.json
```
