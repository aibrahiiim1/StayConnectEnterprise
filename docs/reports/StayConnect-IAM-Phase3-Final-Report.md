...
- **HEAD commit:** `7560dd0`
- **Provenance (generation HEAD = inventory_head):** `3f6bb8f598d3f246cfa2b8cf9ed5a3306feace5c`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/architecture/Phase4-Financial-Schema-Gap-Audit.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_3f6bb8f.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
| `governance/transitions/T0035.json` | CREATED | `A` | governance | GOVERNANCE | rollback REMOVES it | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
| `iam_v2_scratch/phase4_0011_financial.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
| `scripts/phase4-pg-integration.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
```text
 ...
 .../Phase4-Financial-Schema-Gap-Audit.md           |  410 +++
 ...
 docs/manifests/Phase3-change-manifest.md           |  996 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1803 ++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 294779 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111115 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42055 bytes
 .../chatgpt/phase-evidence/GIT_STAT_3f6bb8f.txt    |    4 +
 ...
 iam_v2_scratch/phase4_0011_financial.sh            |  541 ++++
 ...
 331 files changed, 68509 insertions(+), 728 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_3f6bb8f.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_7560dd0.txt
...
M  governance/transitions/T0035.json
```

## Commits in range (`git log --oneline <base>..HEAD`)
```text
3f6bb8f Phase 4 (delivery_head): manifest + rebuilt packs + pointer
