...
| `hotel-admin/tsconfig.json` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 4: dependency evidence for both trees, GHSA triage, attempted-and-reverted Next 16, production advisory gate |
...
```text
 ...
 hotel-admin/AGENTS.md                              |    9 +
 hotel-admin/CLAUDE.md                              |    1 +
