...
- **HEAD commit:** `3ad3c78`
- **Provenance (generation HEAD = inventory_head):** `3ad3c7832c4fd2debc1b5df90dac15e683b06c88`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_3ad3c78.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4 (delivery_head): advance the candidate pointers to the cleaned software head |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           | 1176 ++++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1983 +++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 299452 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111138 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42052 bytes
 .../chatgpt/phase-evidence/GIT_STAT_3ad3c78.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1176 ++++++++
 ...
 405 files changed, 84495 insertions(+), 1125 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_3ad3c78.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_9fbc284.txt
