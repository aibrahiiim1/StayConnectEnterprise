...
| `.github/workflows/phase4-financial-core.yml` | CREATED | `A` | configuration | CI | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
...
| `data-plane/cmd/edged/auth.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 4: close the construction boundary for real, and deliver the Manual Review operator surface |
...
| `data-plane/cmd/edged/main.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 4: close the construction boundary for real, and deliver the Manual Review operator surface |
| `data-plane/cmd/edged/phase3_api_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: harden Manual Review audit inputs, and add payment/settlement governance (migration 0014) |
...
| `data-plane/internal/iamv2/commerce_repo_pg.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
| `data-plane/internal/iamv2/commerce_settled_grant.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
...
| `data-plane/internal/payment/engine.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
...
| `data-plane/internal/payment/payment.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
| `data-plane/internal/payment/pg_grant_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
| `data-plane/internal/payment/pg_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
| `data-plane/internal/payment/provider.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
| `data-plane/internal/payment/testdouble.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
...
| `docs/architecture/StayConnect-IAM-Phase4-Plan.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4 (delivery_head): T0037 receipt + project-state pointers + regenerated manifest |
...
| `iam_v2_scratch/phase4_0011_financial.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
...
| `iam_v2_scratch/phase4_financial_fixture.sql` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `scripts/ci/phase4-dark-check.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: close the construction boundary for real, and deliver the Manual Review operator surface |
...
| `scripts/phase4-least-privilege.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
| `scripts/phase4-payment-concurrency.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
| `scripts/phase4-pg-integration.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4 (inventory_head): payment runtime, Phase-2 entitlement handoff, migrations 0016-0017, least-privilege roles |
...
```text
 ...
 .github/workflows/phase4-financial-core.yml        |  147 +
 ...
 data-plane/cmd/edged/auth.go                       |   33 +-
 data-plane/cmd/edged/health_checks.go              |    6 +
 data-plane/cmd/edged/main.go                       |   55 +
 .../cmd/edged/phase3_api_integration_test.go       |  470 +++
 ...
 data-plane/internal/iamv2/commerce_repo_pg.go      |  111 +-
 .../internal/iamv2/commerce_settled_grant.go       |  127 +
 ...
 data-plane/internal/payment/engine.go              |  363 +++
 data-plane/internal/payment/export_test.go         |   15 +
 data-plane/internal/payment/granter.go             |   29 +
 data-plane/internal/payment/payment.go             |  183 ++
 .../internal/payment/pg_grant_integration_test.go  |  193 ++
 data-plane/internal/payment/pg_integration_test.go |  485 ++++
 data-plane/internal/payment/provider.go            |   80 +
 data-plane/internal/payment/testdouble.go          |   79 +
 ...
 docs/architecture/StayConnect-IAM-Phase4-Plan.md   |  176 ++
 ...
 iam_v2_scratch/phase4_0011_financial.sh            |  640 +++++
 iam_v2_scratch/phase4_db_invariants.sh             |  218 ++
 iam_v2_scratch/phase4_financial_fixture.sql        |  120 +
 ...
 scripts/ci/phase4-dark-check.sh                    |  143 +
 ...
 scripts/phase4-pg-integration.sh                   |   94 +
