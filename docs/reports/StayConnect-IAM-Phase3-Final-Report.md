...
- **HEAD commit:** `8877c47a6f1df25fab075f1dfda6f01e32846a75`
- **Provenance (generation HEAD = inventory_head):** `8877c47a6f1df25fab075f1dfda6f01e32846a75`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 5 (T0052): the CI gate published nothing, and the pmsd posture was never measured |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 5 (T0052): the CI gate published nothing, and the pmsd posture was never measured |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 5 (T0052): the CI gate published nothing, and the pmsd posture was never measured |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 5 (T0052): the CI gate published nothing, and the pmsd posture was never measured |
...
| `docs/evidence/StayConnect-IAM-Phase5-Evidence.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 (T0052): the CI gate published nothing, and the pmsd posture was never measured |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_8877c47.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (T0052): the CI gate published nothing, and the pmsd posture was never measured |
...
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (T0052): the CI gate published nothing, and the pmsd posture was never measured |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 5 (T0052): the CI gate published nothing, and the pmsd posture was never measured |
...
```text
 ...
 docs/evidence/StayConnect-IAM-Phase5-Evidence.md   |  369 +++
 docs/evidence/phase4/npm-audit-full.json           |   22 +
 docs/evidence/phase4/npm-audit-production.json     |   22 +
 docs/manifests/Phase3-change-manifest.md           | 1377 +++++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 2184 ++++++++++++++
 .../reports/StayConnect-IAM-Phase4-Final-Report.md |  159 +
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 305858 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 114437 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42173 bytes
 .../chatgpt/phase-evidence/GIT_STAT_8877c47.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1364 +++++++++
 ...
 governance/project-state.json                      |  547 +++-
 ...
 476 files changed, 101068 insertions(+), 2245 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_34f09e9.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_8877c47.txt
