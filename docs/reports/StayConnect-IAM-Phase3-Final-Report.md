...
- **HEAD commit:** `3ad3c78`
- **Provenance (generation HEAD = inventory_head):** `35ef249a583133f2ec1d5e977d96632aa4885ee3`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `.github/workflows/phase4-financial-core.yml` | CREATED | `A` | configuration | CI | rollback REMOVES it | Phase 4: extend the DB gate to 0024/0025, measured C1-C38 matrix, Plan and Gap-Audit sync, CI dependency gate and full browser suite |
...
| `data-plane/cmd/scd/tenant_transition.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 4 (0025): zero-attempt recovery retry, marker BEHIND, C27 cross-tenant merchant identity, C35 archive-before-purge |
...
| `data-plane/internal/payment/pg_closure_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4 (0025): zero-attempt recovery retry, marker BEHIND, C27 cross-tenant merchant identity, C35 archive-before-purge |
...
| `deploy/scripts/stayconnect-site-backup.sh` | CREATED | `A` | configuration | DEPLOY | rollback REMOVES it | Phase 4: trusted restore manifest via the pinned registry anchor, proven quiesce, marker excluded from the /etc backup domain, runbook updated |
...
| `docs/PHASE4_DEPENDENCY_TRIAGE.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: dependency evidence for both trees, GHSA triage, attempted-and-reverted Next 16, production advisory gate |
...
| `docs/architecture/Phase4-Financial-Schema-Gap-Audit.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: extend the DB gate to 0024/0025, measured C1-C38 matrix, Plan and Gap-Audit sync, CI dependency gate and full browser suite |
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 (delivery_head): T0040 receipt + project-state pointers |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 (delivery_head): T0040 receipt + project-state pointers |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 (delivery_head): T0040 receipt + project-state pointers |
...
| `docs/architecture/StayConnect-IAM-Phase4-Plan.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: extend the DB gate to 0024/0025, measured C1-C38 matrix, Plan and Gap-Audit sync, CI dependency gate and full browser suite |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 (delivery_head): T0040 receipt + project-state pointers |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
| `exports/chatgpt/phase-evidence/GIT_STAT_35ef249.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
...
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1A-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0040 receipt + project-state pointers |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 (delivery_head): T0040 receipt + project-state pointers |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4 (delivery_head): regenerate packs and manifest for the final software head |
...
| `hotel-admin/e2e/phase4-financial-operator.spec.ts` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: anchor the accessibility E2E on the held table rather than the banner, removing a two-response race |
...
| `iam_v2_scratch/phase4_0011_financial.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: extend the DB gate to 0024/0025, measured C1-C38 matrix, Plan and Gap-Audit sync, CI dependency gate and full browser suite |
...
| `scripts/ci/phase4-dependency-gate.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: dependency evidence for both trees, GHSA triage, attempted-and-reverted Next 16, production advisory gate |
...
```text
 ...
 .github/workflows/phase4-financial-core.yml        |  211 ++
 ...
 data-plane/cmd/scd/tenant_transition.go            |   29 +
 ...
 .../payment/pg_closure_integration_test.go         |  361 +++
 ...
 deploy/scripts/stayconnect-site-backup.sh          |   70 +
 ...
 docs/PHASE4_DEPENDENCY_TRIAGE.md                   |  120 +
 ...
 .../Phase4-Financial-Schema-Gap-Audit.md           |  466 +++
 ...
 docs/architecture/StayConnect-IAM-Phase4-Plan.md   |  212 ++
 ...
 docs/manifests/Phase3-change-manifest.md           | 1173 ++++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1980 +++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 299560 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111126 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42052 bytes
 .../chatgpt/phase-evidence/GIT_STAT_35ef249.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1173 ++++++++
 ...
 hotel-admin/e2e/phase4-financial-operator.spec.ts  |  270 ++
 ...
 iam_v2_scratch/phase4_0011_financial.sh            |  841 ++++++
 ...
 scripts/ci/phase4-dependency-gate.sh               |   99 +
 ...
 405 files changed, 84486 insertions(+), 1125 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_35ef249.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_3ad3c78.txt
