...
| `data-plane/cmd/netd/phase3_enforcement.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
| `data-plane/cmd/netd/phase3_enforcement_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
| `data-plane/cmd/netd/phase3_gate.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
...
| `data-plane/cmd/netd/phase3_provision.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
...
| `data-plane/cmd/netd/phase3_shaping.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
| `data-plane/cmd/netd/phase3_shaping_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
...
| `data-plane/cmd/scd/phase3_auth.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
| `data-plane/cmd/scd/phase3_auth_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
...
| `data-plane/internal/enforce/enforce.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
...
| `data-plane/internal/nft/nft.go` | MODIFIED | `M` | runtime | RUNTIME | rollback RESTORES prior content | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
| `data-plane/internal/nft/nft_phase3_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
...
| `data-plane/migrations/0010_phase3_stay_resolution.up.sql` | CREATED | `A` | database | MIGRATIONS | rollback REMOVES it | Phase 3: make packet authorization, accountable metering and Session state one enforcement contract |
...
| `docs/architecture/adr/ADR-0002-phase3-single-shaping-owner.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3: ADR-0002 amended to the real enforcement model, and Zero-Stale checks for the phrases that drifted |
...
| `tools/validate-project-state.sh` | MODIFIED | `M` | tests/tooling | TOOLING | rollback RESTORES prior content | Phase 3: ADR-0002 amended to the real enforcement model, and Zero-Stale checks for the phrases that drifted |
...
```text
 ...
 data-plane/cmd/netd/phase3_enforcement.go          |   84 +
 data-plane/cmd/netd/phase3_enforcement_test.go     |  784 ++++++
 data-plane/cmd/netd/phase3_gate.go                 |  107 +
 ...
 data-plane/cmd/netd/phase3_provision.go            |  251 ++
 data-plane/cmd/netd/phase3_provision_test.go       |  481 ++++
 data-plane/cmd/netd/phase3_shaping.go              |  622 +++++
 data-plane/cmd/netd/phase3_shaping_test.go         | 1365 +++++++++
 ...
 data-plane/cmd/scd/phase3_auth.go                  |  678 +++++
 data-plane/cmd/scd/phase3_auth_integration_test.go |  826 ++++++
 ...
 data-plane/internal/enforce/enforce.go             |  201 ++
 ...
 data-plane/internal/nft/nft.go                     |  136 +-
 data-plane/internal/nft/nft_phase3_test.go         |  239 ++
 ...
 .../migrations/0010_phase3_stay_resolution.up.sql  | 2951 ++++++++++++++++++++
 ...
 .../phase-evidence/tools/validate-project-state.sh |   33 +-
