...
- **HEAD commit:** `827240b`
- **Provenance (generation HEAD = inventory_head):** `29ad58f9845e1d85afe6222614bc5d29e3939f31`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `exports/chatgpt/phase-evidence/GIT_STAT_29ad58f.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4: point the authoritative CI facts at the current head |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           | 1076 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1883 ++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 296375 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111108 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42053 bytes
 .../chatgpt/phase-evidence/GIT_STAT_29ad58f.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1076 +++++++
 ...
 374 files changed, 76661 insertions(+), 750 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_29ad58f.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_7755bdd.txt
...
```text
HISTORICAL: 29ad58f Phase 4: point the authoritative CI facts at the current head
