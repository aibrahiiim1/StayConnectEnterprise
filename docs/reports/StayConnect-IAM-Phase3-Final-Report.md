...
- **HEAD commit:** `50c92d0`
- **Provenance (generation HEAD = inventory_head):** `50c92d0ba0ebfa4a66a606e3806bd04918ea1bc7`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
...
| `docs/architecture/StayConnect-IAM-Phase3-Plan.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 (inventory_head): ACCEPTED AND CLOSED at verified DARK maturity, with the audit chronology corrected |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
| `docs/evidence/Phase3-Final-Live-Acceptance-Record.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_50c92d0.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/governance/decision-register.json` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 3 (delivery_head): complete staged manifest + rebuilt packs + pointer + report-embedded manifest |
...
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
...
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
...
| `governance/decision-register.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3 (inventory_head): ACCEPTED AND CLOSED at verified DARK maturity, with the audit chronology corrected |
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
...
| `tools/tests/current_state_parity/run_negative.py` | CREATED | `A` | tests/tooling | TOOLING | rollback REMOVES it | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
...
| `tools/validate-current-state-parity.py` | CREATED | `A` | tests/tooling | TOOLING | rollback REMOVES it | Phase 3 (inventory_head): merge-readiness corrections â€” a cited evidence file that was silently gitignored, and four stale current-state claims |
| `tools/validate-pr-metadata.sh` | CREATED | `A` | tests/tooling | TOOLING | rollback REMOVES it | Phase 3 (inventory_head): teach the PR-metadata gate that acceptance is a real state |
| `tools/validate-project-state.sh` | MODIFIED | `M` | tests/tooling | TOOLING | rollback RESTORES prior content | Phase 3 (delivery_head): complete staged manifest + rebuilt packs + pointer + report-embedded manifest |
...
```text
 ...
 docs/architecture/StayConnect-IAM-Phase3-Plan.md   |  253 ++
 ...
 .../Phase3-Final-Live-Acceptance-Record.md         |  103 +
 .../StayConnect-IAM-Phase3-Schema-Gap-Audit.md     |  109 +
 docs/manifests/Phase3-change-manifest.md           |  828 ++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1614 +++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 289092 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 109151 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 41915 bytes
 .../chatgpt/phase-evidence/GIT_STAT_50c92d0.txt    |    4 +
 ...
 .../StayConnect-IAM-Phase3-Plan.md                 |  253 ++
 governance/decision-register.json                  |   36 +-
...
A  exports/chatgpt/phase-evidence/GIT_STAT_50c92d0.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_541004e.txt
