...
- **HEAD commit:** `b52259d31f5f4c6c87cc9cc870b993d686971dfc`
- **Provenance (generation HEAD = inventory_head):** `b52259d31f5f4c6c87cc9cc870b993d686971dfc`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/acceptance/StayConnect-IAM-Phase5-Live-Dark-Acceptance.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 closure correction: the receipt described its own future, and the next action was unrecognised |
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 5 ACCEPTED AND CLOSED at verified LIVE-DARK / NO-FINANCIAL-TRAFFIC (D22 / T0053) |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 5 ACCEPTED AND CLOSED at verified LIVE-DARK / NO-FINANCIAL-TRAFFIC (D22 / T0053) |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 5 ACCEPTED AND CLOSED at verified LIVE-DARK / NO-FINANCIAL-TRAFFIC (D22 / T0053) |
...
| `docs/architecture/StayConnect-IAM-Phase5-Plan.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 closure correction: the receipt described its own future, and the next action was unrecognised |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 5 ACCEPTED AND CLOSED at verified LIVE-DARK / NO-FINANCIAL-TRAFFIC (D22 / T0053) |
...
| `docs/evidence/StayConnect-IAM-Phase5-Evidence.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 closure correction: the receipt described its own future, and the next action was unrecognised |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `docs/reports/StayConnect-IAM-Phase5-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 5 closure correction: the receipt described its own future, and the next action was unrecognised |
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_b52259d.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `exports/chatgpt/phase-evidence/governance/decision-register.json` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 ACCEPTED AND CLOSED at verified LIVE-DARK / NO-FINANCIAL-TRAFFIC (D22 / T0053) |
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 5 ACCEPTED AND CLOSED at verified LIVE-DARK / NO-FINANCIAL-TRAFFIC (D22 / T0053) |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 5 (delivery_head): closure pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `governance/decision-register.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 5 closure correction: the receipt described its own future, and the next action was unrecognised |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 5 closure correction: the receipt described its own future, and the next action was unrecognised |
...
| `tools/validate-current-state-parity.py` | CREATED | `A` | tests/tooling | TOOLING | rollback REMOVES it | Phase 5 ACCEPTED AND CLOSED at verified LIVE-DARK / NO-FINANCIAL-TRAFFIC (D22 / T0053) |
...
```text
 ...
 docs/evidence/StayConnect-IAM-Phase5-Evidence.md   |  405 +++
 docs/evidence/phase4/npm-audit-full.json           |   22 +
 docs/evidence/phase4/npm-audit-production.json     |   22 +
 docs/manifests/Phase3-change-manifest.md           | 1384 +++++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 2191 ++++++++++++++
 .../reports/StayConnect-IAM-Phase4-Final-Report.md |  159 +
 .../reports/StayConnect-IAM-Phase5-Final-Report.md |  198 ++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 305989 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 115303 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42131 bytes
 .../chatgpt/phase-evidence/GIT_STAT_9a1f356.txt    |    4 -
 .../chatgpt/phase-evidence/GIT_STAT_b52259d.txt    |    4 +
 ...
 .../StayConnect-IAM-Phase2-Live-Dark-Acceptance.md |    2 +-
 .../governance/decision-register.json              |  549 +++-
 ...
 .../Phase3-change-manifest.md                      | 1388 +++++++++
 ...
 governance/project-state.json                      |  595 +++-
 ...
 tools/validate-current-state-parity.py             | 1063 +++++++
 ...
 479 files changed, 101687 insertions(+), 2245 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_44917c9.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_b52259d.txt
