...
- **HEAD commit:** `efdd580`
- **Provenance (generation HEAD = inventory_head):** `ffaaabeebd4333b4cdb27e9eb7f8a666022d3389`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `.github/workflows/phase4-financial-core.yml` | CREATED | `A` | configuration | CI | rollback REMOVES it | Phase 4: close the construction boundary for real, and deliver the Manual Review operator surface |
...
| `data-plane/cmd/edged/phase3_api_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `data-plane/cmd/edged/phase4_review_api_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: correct Manual Review scope, evidence and role truth |
| `data-plane/cmd/edged/phase4_review_evidence.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `data-plane/cmd/edged/resources_phase4_review.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `docs/architecture/Phase4-Financial-Schema-Gap-Audit.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: correct Manual Review scope, evidence and role truth |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: correct Manual Review scope, evidence and role truth |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_ffaaabe.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `governance/transitions/T0034.json` | CREATED | `A` | governance | GOVERNANCE | rollback REMOVES it | Phase 4: correct Manual Review scope, evidence and role truth |
...
| `iam_v2_scratch/phase4_0011_financial.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: close the production construction boundary and correct the reversal model to the FINAL contract |
...
| `scripts/phase4-pg-integration.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: close the construction boundary for real, and deliver the Manual Review operator surface |
...
```text
 ...
 .../cmd/edged/phase3_api_integration_test.go       |  439 +++
 ...
 .../edged/phase4_review_api_integration_test.go    |  595 ++++
 data-plane/cmd/edged/phase4_review_evidence.go     |  163 ++
 ...
 data-plane/cmd/edged/resources_phase4_review.go    |  454 +++
 ...
 .../Phase4-Financial-Schema-Gap-Audit.md           |  381 +++
 ...
 docs/manifests/Phase3-change-manifest.md           |  988 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1795 ++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 294601 bytes
 ...
 .../chatgpt/phase-evidence/GIT_STAT_ffaaabe.txt    |    4 +
 ...
 governance/decision-register.json                  |   68 +-
 governance/project-state.json                      |  221 +-
 ...
 iam_v2_scratch/phase4_0011_financial.sh            |  474 ++++
 ...
 328 files changed, 67781 insertions(+), 728 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_efdd580.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_ffaaabe.txt
...
M  governance/transitions/T0034.json
```

## Commits in range (`git log --oneline <base>..HEAD`)
```text
ffaaabe Phase 4 (delivery_head): manifest + rebuilt packs + pointer
