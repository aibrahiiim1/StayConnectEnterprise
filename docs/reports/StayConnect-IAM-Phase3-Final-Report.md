...
- **HEAD commit:** `8b80184`
- **Provenance (generation HEAD = inventory_head):** `8b8018404bf172859221236b55d1f1560962aa3c`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 (delivery_head): hygiene-round manifest + rebuilt packs + pointer + report-embedded manifest |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3 (delivery_head): hygiene-round manifest + rebuilt packs + pointer + report-embedded manifest |
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
| `exports/chatgpt/phase-evidence/GIT_STAT_8b80184.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
...
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Close five residual findings: cloned host identity, Central-only Edge vhosts, artifact-audit record (T0027) |
...
| `tools/tests/project_state_validator/run_mutations.py` | MODIFIED | `M` | tests/tooling | TOOLING | rollback RESTORES prior content | Post-closure hygiene: stop two surfaces presenting superseded state as current (T0026) |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  839 ++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1641 +++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 290696 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 110095 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42000 bytes
 .../chatgpt/phase-evidence/GIT_STAT_8b80184.txt    |    4 +
 ...
 287 files changed, 57710 insertions(+), 723 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_8b80184.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_df55a09.txt
