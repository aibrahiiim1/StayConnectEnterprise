...
- **HEAD commit:** `6361f07`
- **Provenance (generation HEAD = inventory_head):** `6361f079ae6a01db7c1cf976648bb62e88008520`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `data-plane/internal/posting/engine.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `data-plane/internal/posting/pg_integration_test.go` | CREATED | `A` | tests/tooling | RUNTIME | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `data-plane/internal/posting/repo.go` | CREATED | `A` | runtime | RUNTIME | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `docs/architecture/Phase4-Financial-Schema-Gap-Audit.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `docs/architecture/StayConnect-IAM-Phase4-Plan.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_6361f07.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `exports/chatgpt/phase1b-planning/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 hardening (delivery_head): complete staged manifest + rebuilt packs + pointer + report-embedded manifest |
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Handoff.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 hardening (delivery_head): complete staged manifest + rebuilt packs + pointer + report-embedded manifest |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase0-Contract.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 hardening (delivery_head): complete staged manifest + rebuilt packs + pointer + report-embedded manifest |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1A-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 hardening (delivery_head): complete staged manifest + rebuilt packs + pointer + report-embedded manifest |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 hardening (delivery_head): complete staged manifest + rebuilt packs + pointer + report-embedded manifest |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4: record the authoritative CI evidence for head f9f13f97 |
...
| `iam_v2_scratch/phase4_0011_financial.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `scripts/ci/phase4-dark-check.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
| `scripts/phase4-pg-integration.sh` | CREATED | `A` | other | OTHER | rollback REMOVES it | Phase 4: harden the financial execution core â€” migration 0012, contract lifecycle, freshness axes, real PA correlation |
...
```text
 ...
 data-plane/internal/posting/engine.go              |  325 +++
 ...
 data-plane/internal/posting/pg_integration_test.go | 1322 +++++++++
 data-plane/internal/posting/posting_test.go        |  498 ++++
 data-plane/internal/posting/repo.go                |  324 +++
 ...
 .../Phase4-Financial-Schema-Gap-Audit.md           |  273 ++
 ...
 docs/manifests/Phase3-change-manifest.md           |  953 +++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1760 ++++++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 294046 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 111110 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42055 bytes
 .../chatgpt/phase-evidence/GIT_STAT_6361f07.txt    |    4 +
 ...
 governance/decision-register.json                  |   68 +-
 governance/project-state.json                      |  215 +-
 ...
 iam_v2_scratch/phase4_0011_financial.sh            |  460 +++
 ...
 scripts/ci/phase4-dark-check.sh                    |   90 +
 ...
 319 files changed, 65326 insertions(+), 727 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_6361f07.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_dd00fac.txt
