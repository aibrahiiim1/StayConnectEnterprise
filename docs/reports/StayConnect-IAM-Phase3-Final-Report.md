...
- **HEAD commit:** `5529f0809c75668a2037bc56c200ff6d709021b3`
- **Provenance (generation HEAD = inventory_head):** `5529f0809c75668a2037bc56c200ff6d709021b3`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3: governance activity transition T0016 (software candidate awaiting Increment 9), doc sync |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 3: governance activity transition T0016 (software candidate awaiting Increment 9), doc sync |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_5529f08.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 3: governance activity transition T0016 (software candidate awaiting Increment 9), doc sync |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           |  669 +++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 1078 ++++++++
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 284167 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 104094 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42084 bytes
 .../chatgpt/phase-evidence/GIT_STAT_5529f08.txt    |    4 +
 ...
 225 files changed, 41795 insertions(+), 458 deletions(-)
```
...
A  exports/chatgpt/phase-evidence/GIT_STAT_5529f08.txt
D  exports/chatgpt/phase-evidence/GIT_STAT_762909c.txt
