...
- **HEAD commit:** `a8cea44`
- **Provenance (generation HEAD = inventory_head):** `a8cea442b00a7c093f6af539553de0c21040b217`  ·  path/status set covers the complete `base..delivery_head` diff (delivery_head = this staged content once committed).
...
| `docs/acceptance/StayConnect-IAM-Phase4-Live-Dark-Acceptance.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4: record PR #12 (open, unmerged) and the closure-head CI evidence |
...
| `docs/architecture/StayConnect-IAM-Phase0-Contract.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `docs/architecture/StayConnect-IAM-Phase1A-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `docs/architecture/StayConnect-IAM-Phase1B-Plan.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `docs/architecture/StayConnect-IAM-Phase4-Plan.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4 closure correction (T0046): static current-state prose outside the generated block |
...
| `docs/context/StayConnect-IAM-Handoff.md` | MODIFIED | `M` | documentation | DOCS | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `docs/manifests/Phase3-change-manifest.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4 (delivery_head): correction pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `docs/reports/StayConnect-IAM-Phase3-Final-Report.md` | CREATED | `A` | documentation | DOCS | rollback REMOVES it | Phase 4 (delivery_head): correction pointer, complete staged manifest, rebuilt packs and report-embedded manifest |
...
| `exports/chatgpt/StayConnectEnterprise-ChatGPT-Project-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/StayConnectEnterprise-Phase-Evidence-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/StayConnectEnterprise-Phase1B-Planning-Pack.zip` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `exports/chatgpt/phase-evidence/GIT_STAT_a8cea44.txt` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | (no commit subject in range) |
| `exports/chatgpt/phase-evidence/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `exports/chatgpt/phase-evidence/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `exports/chatgpt/phase1b-planning/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/phase1b-planning/PACK_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/phase1b-planning/REPOSITORY_ARTIFACT_SHA256SUMS.txt` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/phase1b-planning/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/stayconnectenterprise/00-START-HERE.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/stayconnectenterprise/MANIFEST.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/stayconnectenterprise/PROJECT-INSTRUCTIONS.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `exports/chatgpt/stayconnectenterprise/Phase3-change-manifest.md` | EXPORTED | `A` | export | EXPORT | rollback REMOVES it | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Handoff.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase0-Contract.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1A-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
| `exports/chatgpt/stayconnectenterprise/StayConnect-IAM-Phase1B-Plan.md` | EXPORTED | `M` | export | EXPORT | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `governance/project-state.json` | MODIFIED | `M` | governance | GOVERNANCE | rollback RESTORES prior content | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `tools/tests/current_state_parity/run_negative.py` | CREATED | `A` | tests/tooling | TOOLING | rollback REMOVES it | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
| `tools/validate-current-state-parity.py` | CREATED | `A` | tests/tooling | TOOLING | rollback REMOVES it | Phase 4 closure correction (T0047): the generated block is the only carrier of current state in 00-START-HERE |
...
```text
 ...
 docs/manifests/Phase3-change-manifest.md           | 1247 ++++++++
 .../reports/StayConnect-IAM-Phase2-Final-Report.md |    4 +-
 .../reports/StayConnect-IAM-Phase3-Final-Report.md | 2054 +++++++++++++
 .../reports/StayConnect-IAM-Phase4-Final-Report.md |  158 +
 .../StayConnectEnterprise-ChatGPT-Project-Pack.zip |  Bin 250675 -> 302556 bytes
 .../StayConnectEnterprise-Phase-Evidence-Pack.zip  |  Bin 101471 -> 113006 bytes
 ...StayConnectEnterprise-Phase1B-Planning-Pack.zip |  Bin 41921 -> 42092 bytes
 .../chatgpt/phase-evidence/GIT_STAT_9a1f356.txt    |    4 -
 .../chatgpt/phase-evidence/GIT_STAT_a8cea44.txt    |    4 +
 ...
 .../Phase3-change-manifest.md                      | 1247 ++++++++
 ...
 governance/project-state.json                      |  487 ++-
 ...
 tools/tests/current_state_parity/run_negative.py   |  620 ++++
 ...
 tools/validate-current-state-parity.py             |  928 ++++++
 ...
 428 files changed, 90817 insertions(+), 2244 deletions(-)
```
...
D  exports/chatgpt/phase-evidence/GIT_STAT_a2a17db.txt
A  exports/chatgpt/phase-evidence/GIT_STAT_a8cea44.txt
