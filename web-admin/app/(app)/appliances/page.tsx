        ...
        <Card className="mb-6 border-ok">
          ...
          <CardBody>
            <div className="text-sm text-muted mb-2">
              This is the only time the full token is shown. Paste it on the appliance as{" "}
              <span className="font-mono">SCD_BOOTSTRAP_TOKEN</span> in <span className="font-mono">/etc/stayconnect/scd.env</span>.
            </div>
            <div className="flex items-center gap-2">
