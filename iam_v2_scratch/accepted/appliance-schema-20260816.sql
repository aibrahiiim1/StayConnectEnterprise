...
--
-- Name: iam_v2; Type: SCHEMA; Schema: -; Owner: iam_v2_owner
--
...
--
-- Name: activate_session_enforcement(uuid, uuid, uuid, text, integer, bigint); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.activate_session_enforcement(p_tenant uuid, p_site uuid, p_session uuid, p_bridge text, p_class_minor integer, p_epoch bigint) OWNER TO iam_v2_owner;

--
-- Name: allocate_class_generation(uuid, uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.allocate_class_generation(p_tenant uuid, p_site uuid, p_appliance uuid) OWNER TO iam_v2_owner;

--
-- Name: allocate_p_number(uuid, uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.allocate_p_number(p_tenant uuid, p_site uuid, p_interface uuid) OWNER TO iam_v2_owner;

--
-- Name: apply_adjustment(uuid, text, text, uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.apply_adjustment(p_ent uuid, p_field text, p_new text, p_actor uuid, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: apply_entitlement_transition(uuid, text, timestamp with time zone, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.apply_entitlement_transition(p_ent uuid, p_to text, p_at timestamp with time zone, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: apply_payment_callback_v2(uuid, text, uuid, text, text, text, text, text, jsonb); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.apply_payment_callback_v2(p_tenant uuid, p_provider text, p_merchant uuid, p_client_ref text, p_provider_event_id text, p_event_type text, p_asserted_status text, p_provider_txn_ref text, p_evidence jsonb) OWNER TO iam_v2_owner;

--
-- Name: authorize_entitlement_device(uuid, uuid, timestamp with time zone); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.authorize_entitlement_device(p_ent uuid, p_device uuid, p_at timestamp with time zone) OWNER TO iam_v2_owner;

--
-- Name: begin_controlled_operation(text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.begin_controlled_operation(p_family text) OWNER TO iam_v2_owner;

--
-- Name: begin_payment_execution(uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.begin_payment_execution(p_txn uuid) OWNER TO iam_v2_owner;

--
-- Name: bootstrap_emergency_grace(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.bootstrap_emergency_grace(p_tenant uuid, p_site uuid) OWNER TO iam_v2_owner;

--
-- Name: close_session(uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.close_session(p_session uuid, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: deauthorize_entitlement_device(uuid, uuid, timestamp with time zone, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.deauthorize_entitlement_device(p_ent uuid, p_device uuid, p_at timestamp with time zone, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: emergency_grace_health(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.emergency_grace_health(p_tenant uuid, p_site uuid) OWNER TO iam_v2_owner;

--
-- Name: end_session_enforcement(uuid, uuid, uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.end_session_enforcement(p_tenant uuid, p_site uuid, p_session uuid, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: entitlement_usage_bytes(uuid, timestamp with time zone); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.entitlement_usage_bytes(p_ent uuid, p_at timestamp with time zone) OWNER TO iam_v2_owner;

--
-- Name: grace_package_matches_policy(uuid, uuid, uuid, integer, integer, integer, bigint, integer, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.grace_package_matches_policy(p_tenant uuid, p_site uuid, p_pkg_rev uuid, p_duration integer, p_down integer, p_up integer, p_quota bigint, p_dev_limit integer, p_dev_policy text) OWNER TO iam_v2_owner;

--
-- Name: grace_package_mismatch_reason(uuid, uuid, uuid, integer, integer, integer, bigint, integer, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.grace_package_mismatch_reason(p_tenant uuid, p_site uuid, p_pkg_rev uuid, p_duration integer, p_down integer, p_up integer, p_quota bigint, p_dev_limit integer, p_dev_policy text) OWNER TO iam_v2_owner;

--
-- Name: ingest_absolute_counters(uuid, uuid, uuid, uuid, text, integer, bigint, bigint, bigint, timestamp with time zone); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.ingest_absolute_counters(p_tenant uuid, p_site uuid, p_session uuid, p_source_device uuid, p_bridge text, p_class_minor integer, p_epoch bigint, p_abs_up bigint, p_abs_down bigint, p_sampled_at timestamp with time zone) OWNER TO iam_v2_owner;

--
-- Name: ingest_sample(uuid, bigint, bigint, bigint, integer); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.ingest_sample(p_session uuid, p_seq bigint, p_up bigint, p_down bigint, p_epoch integer) OWNER TO iam_v2_owner;

--
-- Name: issue_or_return_pms_context(uuid, uuid, uuid, uuid, uuid, uuid, uuid, uuid, integer); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.issue_or_return_pms_context(p_tenant uuid, p_site uuid, p_interface uuid, p_revision uuid, p_stay uuid, p_device uuid, p_guest_network uuid, p_request uuid, p_ttl_seconds integer) OWNER TO iam_v2_owner;

--
-- Name: ns_capacity(text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.ns_capacity(p text) OWNER TO iam_v2_owner;

--
-- Name: ns_device_slot(text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.ns_device_slot(p text) OWNER TO iam_v2_owner;

--
-- Name: ns_financial_review(text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.ns_financial_review(p text) OWNER TO iam_v2_owner;

--
-- Name: ns_payment_parent(text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.ns_payment_parent(p text) OWNER TO iam_v2_owner;

--
-- Name: p3_accounting_needs_binding(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_accounting_needs_binding() OWNER TO iam_v2_owner;

--
-- Name: p3_alert_action_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_alert_action_guard() OWNER TO iam_v2_owner;

--
-- Name: p3_alert_open_on_audit(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_alert_open_on_audit() OWNER TO iam_v2_owner;

--
-- Name: p3_checkout_audit_provenance(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_checkout_audit_provenance() OWNER TO iam_v2_owner;

--
-- Name: p3_checkout_grace_audit_appendonly(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_checkout_grace_audit_appendonly() OWNER TO iam_v2_owner;

--
-- Name: p3_controlled_operation_open(text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_controlled_operation_open(p_family text) OWNER TO iam_v2_owner;

--
-- Name: p3_controlled_writer_only(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_controlled_writer_only() OWNER TO iam_v2_owner;

--
-- Name: p3_controlled_writer_owner(text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_controlled_writer_owner(p_family text) OWNER TO iam_v2_owner;

--
-- Name: p3_detect_delayed_accounting(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_detect_delayed_accounting() OWNER TO iam_v2_owner;

--
-- Name: p3_eda_insert_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_eda_insert_guard() OWNER TO iam_v2_owner;

--
-- Name: p3_entitlement_at(uuid, timestamp with time zone); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_entitlement_at(p_session uuid, p_at timestamp with time zone) OWNER TO iam_v2_owner;

--
-- Name: p3_entitlement_status_coherent(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_entitlement_status_coherent() OWNER TO iam_v2_owner;

--
-- Name: p3_est_insert_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_est_insert_guard() OWNER TO iam_v2_owner;

--
-- Name: p3_expected_class_minor(inet); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_expected_class_minor(p_ip inet) OWNER TO iam_v2_owner;

--
-- Name: p3_grace_config_version_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_grace_config_version_guard() OWNER TO iam_v2_owner;

--
-- Name: p3_history_appendonly(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_history_appendonly() OWNER TO iam_v2_owner;

--
-- Name: p3_rederive_entitlement_times(uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_rederive_entitlement_times(p_ent uuid) OWNER TO iam_v2_owner;

--
-- Name: p3_reserved_grace_codes(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_reserved_grace_codes() OWNER TO iam_v2_owner;

--
-- Name: p3_seb_appendonly(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_seb_appendonly() OWNER TO iam_v2_owner;

--
-- Name: p3_seb_insert_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_seb_insert_guard() OWNER TO iam_v2_owner;

--
-- Name: p3_session_close_binding(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_session_close_binding() OWNER TO iam_v2_owner;

--
-- Name: p3_session_open_binding(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_session_open_binding() OWNER TO iam_v2_owner;

--
-- Name: p3_stay_event_appendonly(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_stay_event_appendonly() OWNER TO iam_v2_owner;

--
-- Name: p3_stay_lifecycle_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p3_stay_lifecycle_guard() OWNER TO iam_v2_owner;

--
-- Name: p4_apply_provider_outcome(text, text, text, text, text, jsonb); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_apply_provider_outcome(p_client_ref text, p_provider_event_id text, p_event_type text, p_outcome text, p_provider_txn_ref text, p_evidence jsonb) OWNER TO iam_v2_owner;

--
-- Name: p4_assert_compliance_archived(uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_assert_compliance_archived(p_tenant uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_assert_financial_actor(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_assert_financial_actor(p_tenant uuid, p_actor uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_attempt_freshness_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_attempt_freshness_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_attempt_lifecycle_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_attempt_lifecycle_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_attempt_retry_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_attempt_retry_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_authorize_zero_attempt_retry(uuid, uuid, text, jsonb); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_authorize_zero_attempt_retry(p_posting uuid, p_actor uuid, p_reason text, p_evidence jsonb) OWNER TO iam_v2_owner;

--
-- Name: p4_callback_evidence_safe(jsonb); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_callback_evidence_safe(p jsonb) OWNER TO iam_v2_owner;

--
-- Name: p4_consume_retry_authorization(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_consume_retry_authorization() OWNER TO iam_v2_owner;

--
-- Name: p4_current_restore_generation(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_current_restore_generation(p_tenant uuid, p_site uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_declare_financial_recovery(uuid, uuid, uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_declare_financial_recovery(p_tenant uuid, p_site uuid, p_actor uuid, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: p4_entitlement_grant_kernel(uuid, uuid, uuid, uuid, uuid, uuid, jsonb, uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_entitlement_grant_kernel(p_tenant uuid, p_site uuid, p_purchase uuid, p_voucher uuid, p_account uuid, p_principal uuid, p_snapshot jsonb, p_plan_rev uuid, p_pkg_rev uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_fias_exponent_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_fias_exponent_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_financial_recovery_active(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_financial_recovery_active(p_tenant uuid, p_site uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_grant_paid_entitlement(uuid, uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_grant_paid_entitlement(p_tenant uuid, p_site uuid, p_settlement uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_grant_quoted_entitlement(uuid, uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_grant_quoted_entitlement(p_tenant uuid, p_site uuid, p_purchase uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_hold_financial_rails(uuid, uuid, bigint); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_hold_financial_rails(p_tenant uuid, p_site uuid, p_epoch bigint) OWNER TO iam_v2_owner;

--
-- Name: p4_insert_entitlement(uuid, uuid, uuid, uuid, uuid, uuid, jsonb, uuid, uuid, text, text, timestamp with time zone, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_insert_entitlement(p_tenant uuid, p_site uuid, p_voucher uuid, p_account uuid, p_principal uuid, p_purchase uuid, p_policy jsonb, p_plan_rev uuid, p_pkg_rev uuid, p_time_mode text, p_end_mode text, p_window_ends timestamp with time zone, p_supersedes uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_interface_decommission_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_interface_decommission_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_interface_freshness_block(uuid, uuid, uuid, uuid, timestamp with time zone); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_interface_freshness_block(p_tenant uuid, p_site uuid, p_interface uuid, p_revision uuid, p_at timestamp with time zone) OWNER TO iam_v2_owner;

--
-- Name: p4_mark_purchase_granted(uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_mark_purchase_granted(p_purchase uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_outbox_recovery_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_outbox_recovery_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_payment_admission_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_payment_admission_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_payment_creation_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_payment_creation_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_payment_identity_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_payment_identity_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_payment_status_machine(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_payment_status_machine() OWNER TO iam_v2_owner;

--
-- Name: p4_posting_currency_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_posting_currency_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_posting_freshness_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_posting_freshness_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_posting_lifecycle_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_posting_lifecycle_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_reconcile_financial_epoch(uuid, uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_reconcile_financial_epoch(p_tenant uuid, p_site uuid, p_system_identity text) OWNER TO iam_v2_owner;

--
-- Name: p4_reconcile_financial_epoch_v2(uuid, uuid, text, bigint, boolean); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_reconcile_financial_epoch_v2(p_tenant uuid, p_site uuid, p_system_identity text, p_marker_generation bigint, p_marker_present boolean) OWNER TO iam_v2_owner;

--
-- Name: p4_record_compliance_archive(uuid, uuid, text, text, jsonb); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_record_compliance_archive(p_tenant uuid, p_site uuid, p_manifest_sha text, p_artifact_path text, p_row_counts jsonb) OWNER TO iam_v2_owner;

--
-- Name: p4_record_compliance_receipt(uuid, text, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_record_compliance_receipt(p_archive uuid, p_authority text, p_reference text) OWNER TO iam_v2_owner;

--
-- Name: p4_record_supported_restore(uuid, uuid, bigint, text, timestamp with time zone, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_record_supported_restore(p_tenant uuid, p_site uuid, p_generation bigint, p_manifest_sha text, p_backup_taken_at timestamp with time zone, p_restored_by text) OWNER TO iam_v2_owner;

--
-- Name: p4_recovery_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_recovery_gate() OWNER TO iam_v2_owner;

--
-- Name: p4_recovery_hold_immutable(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_recovery_hold_immutable() OWNER TO iam_v2_owner;

--
-- Name: p4_release_financial_recovery(uuid, uuid, uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_release_financial_recovery(p_tenant uuid, p_site uuid, p_actor uuid, p_note text) OWNER TO iam_v2_owner;

--
-- Name: p4_resolve_payment_account(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_resolve_payment_account(p_tenant uuid, p_site uuid) OWNER TO iam_v2_owner;

--
-- Name: p4_resolve_recovery_hold(uuid, text, uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_resolve_recovery_hold(p_hold uuid, p_resolution text, p_actor uuid, p_note text) OWNER TO iam_v2_owner;

--
-- Name: p4_reversal_ledger_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_reversal_ledger_guard() OWNER TO iam_v2_owner;

--
-- Name: p4_reversal_never_executes(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_reversal_never_executes() OWNER TO iam_v2_owner;

--
-- Name: p4_review_writer_only(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_review_writer_only() OWNER TO iam_v2_owner;

--
-- Name: p4_settlement_state_machine(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_settlement_state_machine() OWNER TO iam_v2_owner;

--
-- Name: p4_terminate_live_entitlement_for_subject(uuid, uuid, uuid, uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.p4_terminate_live_entitlement_for_subject(p_tenant uuid, p_site uuid, p_voucher uuid, p_account uuid, p_principal uuid) OWNER TO iam_v2_owner;

--
-- Name: p5_begin_controlled_operation(text); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p5_begin_controlled_operation(p_family text) OWNER TO stayconnect;

--
-- Name: p5_controlled_operation_open(text); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p5_controlled_operation_open(p_family text) OWNER TO stayconnect;

--
-- Name: p5_controlled_writer_only(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p5_controlled_writer_only() OWNER TO stayconnect;

--
-- Name: p5_entitlement_transfer_guard(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p5_entitlement_transfer_guard() OWNER TO stayconnect;

--
-- Name: p5_post_stay_authenticable(uuid, uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p5_post_stay_authenticable(p_tenant uuid, p_site uuid, p_profile uuid) OWNER TO stayconnect;

--
-- Name: p5_post_stay_profile_guard(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p5_post_stay_profile_guard() OWNER TO stayconnect;

--
-- Name: p5_stay_link_guard(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p5_stay_link_guard() OWNER TO stayconnect;

--
-- Name: p6_data_crossing(uuid); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_data_crossing(p_entitlement uuid) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_data_crossing(p_entitlement uuid); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_due_terminal(uuid); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_due_terminal(p_entitlement uuid) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_due_terminal(p_entitlement uuid); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_exhaustion_instant(uuid); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_exhaustion_instant(p_entitlement uuid) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_exhaustion_instant(p_entitlement uuid); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_expire_entitlement(uuid); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_expire_entitlement(p_entitlement uuid) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_expire_entitlement(p_entitlement uuid); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_guest_device_actions_append_only(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_guest_device_actions_append_only() OWNER TO stayconnect;

--
-- Name: p6_guest_release_device(uuid, uuid, integer); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_guest_release_device(p_entitlement uuid, p_device uuid, p_max_releases_per_hour integer) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_guest_release_device(p_entitlement uuid, p_device uuid, p_max_releases_per_hour integer); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_guest_release_device_policy(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_guest_release_device_policy(p_entitlement uuid, p_device uuid) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_guest_release_device_policy(p_entitlement uuid, p_device uuid); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_online_watermark_monotonic(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_online_watermark_monotonic() OWNER TO stayconnect;

--
-- Name: p6_over_budget_now(uuid); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_over_budget_now(p_entitlement uuid) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_over_budget_now(p_entitlement uuid); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_record_time_termination(uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_record_time_termination(p_entitlement uuid, p_cause text) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_record_time_termination(p_entitlement uuid, p_cause text); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_session_requires_authorized_binding(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_session_requires_authorized_binding() OWNER TO stayconnect;

--
-- Name: FUNCTION p6_session_requires_authorized_binding(); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_set_guest_device_self_service(uuid, uuid, uuid, boolean, uuid, text, text); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_set_guest_device_self_service(p_tenant uuid, p_site uuid, p_appliance uuid, p_on boolean, p_operator uuid, p_operator_label text, p_reason text) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_set_guest_device_self_service(p_tenant uuid, p_site uuid, p_appliance uuid, p_on boolean, p_operator uuid, p_operator_label text, p_reason text); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_setting_changes_append_only(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_setting_changes_append_only() OWNER TO stayconnect;

--
-- Name: p6_skipped_intervals_append_only(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_skipped_intervals_append_only() OWNER TO stayconnect;

--
-- Name: p6_suspend_over_budget(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_suspend_over_budget(p_tenant uuid, p_site uuid) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_suspend_over_budget(p_tenant uuid, p_site uuid); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: p6_termination_evidence_append_only(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_termination_evidence_append_only() OWNER TO stayconnect;

--
-- Name: p6_termination_evidence_matches_transition(); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_termination_evidence_matches_transition() OWNER TO stayconnect;

--
-- Name: p6_tick_online_time(uuid, uuid, timestamp with time zone, integer, uuid[], timestamp with time zone[]); Type: FUNCTION; Schema: iam_v2; Owner: stayconnect
--
...
ALTER FUNCTION iam_v2.p6_tick_online_time(p_tenant uuid, p_site uuid, p_now timestamp with time zone, p_max_charge_seconds integer, p_capped_entitlements uuid[], p_caps timestamp with time zone[]) OWNER TO stayconnect;

--
-- Name: FUNCTION p6_tick_online_time(p_tenant uuid, p_site uuid, p_now timestamp with time zone, p_max_charge_seconds integer, p_capped_entitlements uuid[], p_caps timestamp with time zone[]); Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: publish_checkout_grace_config(uuid, uuid, uuid, integer, integer, integer, bigint, integer, text, integer); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.publish_checkout_grace_config(p_tenant uuid, p_site uuid, p_pkg_rev uuid, p_duration integer, p_down integer, p_up integer, p_quota bigint, p_dev_limit integer, p_dev_policy text, p_eligibility integer) OWNER TO iam_v2_owner;

--
-- Name: publish_checkout_grace_policy(uuid, uuid, uuid, integer, integer, integer, bigint, integer, text, integer, integer, uuid, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.publish_checkout_grace_policy(p_tenant uuid, p_site uuid, p_pkg_rev uuid, p_duration integer, p_down integer, p_up integer, p_quota bigint, p_dev_limit integer, p_dev_policy text, p_eligibility integer, p_expected_version integer, p_actor uuid, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: rebind_session_entitlement(uuid, uuid, timestamp with time zone); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.rebind_session_entitlement(p_session uuid, p_ent uuid, p_at timestamp with time zone) OWNER TO iam_v2_owner;

--
-- Name: record_alert_action(uuid, uuid, uuid, text, uuid, text, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.record_alert_action(p_tenant uuid, p_site uuid, p_audit uuid, p_action text, p_actor uuid, p_reason text, p_expected_state text) OWNER TO iam_v2_owner;

--
-- Name: record_auth_context_offer(uuid, uuid, uuid, uuid, integer, bigint, timestamp with time zone); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.record_auth_context_offer(p_tenant uuid, p_site uuid, p_auth_context uuid, p_package_revision uuid, p_tier integer, p_evidence_version bigint, p_expires_at timestamp with time zone) OWNER TO iam_v2_owner;

--
-- Name: record_posting_review_action(uuid, text, uuid, text, jsonb, integer, bigint); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.record_posting_review_action(p_posting uuid, p_action text, p_actor uuid, p_reason text, p_evidence jsonb, p_expected_version integer, p_reversal_amount bigint) OWNER TO iam_v2_owner;

--
-- Name: register_class_origin(uuid, uuid, uuid, uuid, text, integer, bigint, bigint, bigint, timestamp with time zone); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.register_class_origin(p_tenant uuid, p_site uuid, p_session uuid, p_source_device uuid, p_bridge text, p_class_minor integer, p_epoch bigint, p_origin_up bigint, p_origin_down bigint, p_created_at timestamp with time zone) OWNER TO iam_v2_owner;

--
-- Name: reserve_device_slot(uuid, uuid, text, text, integer); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.reserve_device_slot(p_ent uuid, p_dev uuid, p_cred text, p_appliance text, p_max integer) OWNER TO iam_v2_owner;

--
-- Name: selectable_grace_packages(uuid, uuid); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.selectable_grace_packages(p_tenant uuid, p_site uuid) OWNER TO iam_v2_owner;

--
-- Name: supersede_entitlement_transition(uuid, text, timestamp with time zone, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.supersede_entitlement_transition(p_target uuid, p_to text, p_at timestamp with time zone, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: terminate_entitlement_at_boundary(uuid, timestamp with time zone, text); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.terminate_entitlement_at_boundary(p_ent uuid, p_at timestamp with time zone, p_reason text) OWNER TO iam_v2_owner;

--
-- Name: trg_entitlement_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.trg_entitlement_guard() OWNER TO iam_v2_owner;

--
-- Name: trg_offer_quote_immutable(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.trg_offer_quote_immutable() OWNER TO iam_v2_owner;

--
-- Name: trg_posting_attempt_oneway(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.trg_posting_attempt_oneway() OWNER TO iam_v2_owner;

--
-- Name: trg_posting_charge_gate(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.trg_posting_charge_gate() OWNER TO iam_v2_owner;

--
-- Name: trg_purchase_quote_pin_equal(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.trg_purchase_quote_pin_equal() OWNER TO iam_v2_owner;

--
-- Name: trg_reject_update_delete(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.trg_reject_update_delete() OWNER TO iam_v2_owner;

--
-- Name: trg_reject_update_delete_ptx_events(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.trg_reject_update_delete_ptx_events() OWNER TO iam_v2_owner;

--
-- Name: trg_secret_gen_guard(); Type: FUNCTION; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER FUNCTION iam_v2.trg_secret_gen_guard() OWNER TO iam_v2_owner;
...
--
-- Name: accounting_records; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.accounting_records OWNER TO stayconnect;

--
-- Name: audit_log; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.audit_log OWNER TO stayconnect;

--
-- Name: accounting_checkpoints; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.accounting_checkpoints OWNER TO iam_v2_owner;

--
-- Name: accounting_records; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_alert_actions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.checkout_grace_alert_actions OWNER TO iam_v2_owner;

--
-- Name: checkout_grace_audit; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.checkout_grace_audit OWNER TO iam_v2_owner;

--
-- Name: active_operational_alerts; Type: VIEW; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER VIEW iam_v2.active_operational_alerts OWNER TO iam_v2_owner;

--
-- Name: appliance_class_generation; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.appliance_class_generation OWNER TO iam_v2_owner;

--
-- Name: appliance_product_setting_changes; Type: TABLE; Schema: iam_v2; Owner: stayconnect
--
...
ALTER TABLE iam_v2.appliance_product_setting_changes OWNER TO stayconnect;

--
-- Name: appliance_product_settings; Type: TABLE; Schema: iam_v2; Owner: stayconnect
--
...
ALTER TABLE iam_v2.appliance_product_settings OWNER TO stayconnect;

--
-- Name: TABLE appliance_product_settings; Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: COLUMN appliance_product_settings.guest_device_self_service; Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: auth_context_offers; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.auth_context_offers OWNER TO iam_v2_owner;

--
-- Name: auth_contexts; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.auth_contexts OWNER TO iam_v2_owner;

--
-- Name: auth_resolutions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.auth_resolutions OWNER TO iam_v2_owner;

--
-- Name: checkout_grace_policy_publications; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.checkout_grace_policy_publications OWNER TO iam_v2_owner;

--
-- Name: compliance_archives; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.compliance_archives OWNER TO iam_v2_owner;

--
-- Name: COLUMN compliance_archives.receipt_verified; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: controlled_operation_scope; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.controlled_operation_scope OWNER TO iam_v2_owner;

--
-- Name: TABLE controlled_operation_scope; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: delayed_accounting_records; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.delayed_accounting_records OWNER TO iam_v2_owner;

--
-- Name: device_network_appearances; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.device_network_appearances OWNER TO iam_v2_owner;

--
-- Name: devices; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.devices OWNER TO iam_v2_owner;

--
-- Name: TABLE devices; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_adjustments; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.entitlement_adjustments OWNER TO iam_v2_owner;

--
-- Name: entitlement_boundary_watermarks; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.entitlement_boundary_watermarks OWNER TO iam_v2_owner;

--
-- Name: entitlement_device_authorizations; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.entitlement_device_authorizations OWNER TO iam_v2_owner;

--
-- Name: entitlement_devices; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.entitlement_devices OWNER TO iam_v2_owner;

--
-- Name: COLUMN entitlement_devices.disconnected_reason; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.entitlement_state_transitions OWNER TO iam_v2_owner;

--
-- Name: entitlement_termination_evidence; Type: TABLE; Schema: iam_v2; Owner: stayconnect
--
...
ALTER TABLE iam_v2.entitlement_termination_evidence OWNER TO stayconnect;

--
-- Name: TABLE entitlement_termination_evidence; Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: entitlement_transfers; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.entitlement_transfers OWNER TO iam_v2_owner;

--
-- Name: entitlements; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.entitlements OWNER TO iam_v2_owner;

--
-- Name: COLUMN entitlements.online_time_exhausted_at; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_epoch; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.financial_epoch OWNER TO iam_v2_owner;

--
-- Name: financial_epochs; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.financial_epochs OWNER TO iam_v2_owner;

--
-- Name: TABLE financial_epochs; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: COLUMN financial_epochs.restore_generation; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_recovery_holds; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.financial_recovery_holds OWNER TO iam_v2_owner;

--
-- Name: financial_restore_events; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.financial_restore_events OWNER TO iam_v2_owner;

--
-- Name: folios; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.folios OWNER TO iam_v2_owner;

--
-- Name: guest_access_accounts; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.guest_access_accounts OWNER TO iam_v2_owner;

--
-- Name: guest_device_actions; Type: TABLE; Schema: iam_v2; Owner: stayconnect
--
...
ALTER TABLE iam_v2.guest_device_actions OWNER TO stayconnect;

--
-- Name: TABLE guest_device_actions; Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: guest_network_pms_map; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.guest_network_pms_map OWNER TO iam_v2_owner;

--
-- Name: guest_principal_identities; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.guest_principal_identities OWNER TO iam_v2_owner;

--
-- Name: guest_principals; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.guest_principals OWNER TO iam_v2_owner;

--
-- Name: internet_package_revisions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.internet_package_revisions OWNER TO iam_v2_owner;

--
-- Name: internet_packages; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.internet_packages OWNER TO iam_v2_owner;

--
-- Name: offer_quotes; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.offer_quotes OWNER TO iam_v2_owner;

--
-- Name: online_time_skipped_intervals; Type: TABLE; Schema: iam_v2; Owner: stayconnect
--
...
ALTER TABLE iam_v2.online_time_skipped_intervals OWNER TO stayconnect;

--
-- Name: TABLE online_time_skipped_intervals; Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: package_eligibility_rules; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.package_eligibility_rules OWNER TO iam_v2_owner;

--
-- Name: package_grant_tiers; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.package_grant_tiers OWNER TO iam_v2_owner;

--
-- Name: package_settlement_mappings; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.package_settlement_mappings OWNER TO iam_v2_owner;

--
-- Name: payment_provider_accounts; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.payment_provider_accounts OWNER TO iam_v2_owner;

--
-- Name: TABLE payment_provider_accounts; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: COLUMN payment_provider_accounts.provenance; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transaction_events; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.payment_transaction_events OWNER TO iam_v2_owner;

--
-- Name: TABLE payment_transaction_events; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.payment_transactions OWNER TO iam_v2_owner;

--
-- Name: COLUMN payment_transactions.provider_ref; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: COLUMN payment_transactions.provider_txn_ref; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_pnumber_seq; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.pms_interface_pnumber_seq OWNER TO iam_v2_owner;

--
-- Name: pms_interface_revisions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.pms_interface_revisions OWNER TO iam_v2_owner;

--
-- Name: COLUMN pms_interface_revisions.financial_base_currency; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: COLUMN pms_interface_revisions.financial_base_currency_exponent; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_runtime; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.pms_interface_runtime OWNER TO iam_v2_owner;

--
-- Name: pms_interface_secret_generations; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.pms_interface_secret_generations OWNER TO iam_v2_owner;

--
-- Name: pms_interfaces; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.pms_interfaces OWNER TO iam_v2_owner;

--
-- Name: pms_postings; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.pms_postings OWNER TO iam_v2_owner;

--
-- Name: pms_source_conflicts; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.pms_source_conflicts OWNER TO iam_v2_owner;

--
-- Name: post_stay_profiles; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.post_stay_profiles OWNER TO iam_v2_owner;

--
-- Name: posting_attempt_events; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.posting_attempt_events OWNER TO iam_v2_owner;

--
-- Name: posting_attempts; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.posting_attempts OWNER TO iam_v2_owner;

--
-- Name: CONSTRAINT attempt_gnumber_verified ON posting_attempts; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: CONSTRAINT attempt_rn_verified ON posting_attempts; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_outbox; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.posting_outbox OWNER TO iam_v2_owner;

--
-- Name: COLUMN posting_outbox.enqueued_at; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_review_state; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.posting_review_state OWNER TO iam_v2_owner;

--
-- Name: TABLE posting_review_state; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_execution_state; Type: VIEW; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER VIEW iam_v2.posting_execution_state OWNER TO iam_v2_owner;

--
-- Name: posting_review_actions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.posting_review_actions OWNER TO iam_v2_owner;

--
-- Name: purchases; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.purchases OWNER TO iam_v2_owner;

--
-- Name: service_plan_revisions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.service_plan_revisions OWNER TO iam_v2_owner;

--
-- Name: service_plans; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.service_plans OWNER TO iam_v2_owner;

--
-- Name: session_counter_watermarks; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.session_counter_watermarks OWNER TO iam_v2_owner;

--
-- Name: session_entitlement_bindings; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_online_watermarks; Type: TABLE; Schema: iam_v2; Owner: stayconnect
--
...
ALTER TABLE iam_v2.session_online_watermarks OWNER TO stayconnect;

--
-- Name: TABLE session_online_watermarks; Type: COMMENT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: sessions; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: settlements; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.settlements OWNER TO iam_v2_owner;

--
-- Name: site_checkout_grace_config; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.site_checkout_grace_config OWNER TO iam_v2_owner;

--
-- Name: stay_events; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.stay_events OWNER TO iam_v2_owner;

--
-- Name: stay_folios; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.stay_folios OWNER TO iam_v2_owner;

--
-- Name: stay_guests; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.stay_guests OWNER TO iam_v2_owner;

--
-- Name: stay_links; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.stay_links OWNER TO iam_v2_owner;

--
-- Name: stays; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.stays OWNER TO iam_v2_owner;

--
-- Name: v_financial_payments; Type: VIEW; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER VIEW iam_v2.v_financial_payments OWNER TO iam_v2_owner;

--
-- Name: VIEW v_financial_payments; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: v_financial_recovery; Type: VIEW; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER VIEW iam_v2.v_financial_recovery OWNER TO iam_v2_owner;

--
-- Name: v_financial_review_queue; Type: VIEW; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER VIEW iam_v2.v_financial_review_queue OWNER TO iam_v2_owner;

--
-- Name: v_financial_settlements; Type: VIEW; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER VIEW iam_v2.v_financial_settlements OWNER TO iam_v2_owner;

--
-- Name: v_zero_attempt_recovery_queue; Type: VIEW; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER VIEW iam_v2.v_zero_attempt_recovery_queue OWNER TO iam_v2_owner;

--
-- Name: VIEW v_zero_attempt_recovery_queue; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: voucher_batches; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.voucher_batches OWNER TO iam_v2_owner;

--
-- Name: voucher_code_key_generations; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.voucher_code_key_generations OWNER TO iam_v2_owner;

--
-- Name: vouchers; Type: TABLE; Schema: iam_v2; Owner: iam_v2_owner
--
...
ALTER TABLE iam_v2.vouchers OWNER TO iam_v2_owner;

--
-- Name: appliance_boot_convergence; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.appliance_boot_convergence OWNER TO stayconnect;

--
-- Name: appliance_recovery_events; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.appliance_recovery_events OWNER TO stayconnect;

--
-- Name: appliance_recovery_events_id_seq; Type: SEQUENCE; Schema: public; Owner: stayconnect
--
...
--
-- Name: appliance_service_health; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.appliance_service_health OWNER TO stayconnect;

--
-- Name: appliances; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.appliances OWNER TO stayconnect;

--
-- Name: auth_otps; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.auth_otps OWNER TO stayconnect;

--
-- Name: auth_throttle_buckets; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.auth_throttle_buckets OWNER TO stayconnect;

--
-- Name: TABLE auth_throttle_buckets; Type: COMMENT; Schema: public; Owner: stayconnect
--
...
--
-- Name: backup_records; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.backup_records OWNER TO stayconnect;

--
-- Name: dhcp_pools; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.dhcp_pools OWNER TO stayconnect;

--
-- Name: dhcp_reservations; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.dhcp_reservations OWNER TO stayconnect;

--
-- Name: edge_executed_commands; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.edge_executed_commands OWNER TO stayconnect;

--
-- Name: edge_installed_updates; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.edge_installed_updates OWNER TO stayconnect;

--
-- Name: edge_offline_packages; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.edge_offline_packages OWNER TO stayconnect;

--
-- Name: guest_accounts; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.guest_accounts OWNER TO stayconnect;

--
-- Name: guest_networks; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.guest_networks OWNER TO stayconnect;

--
-- Name: guests; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.guests OWNER TO stayconnect;

--
-- Name: network_apply_events; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.network_apply_events OWNER TO stayconnect;

--
-- Name: network_config_revisions; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.network_config_revisions OWNER TO stayconnect;

--
-- Name: network_config_revisions_seq_seq; Type: SEQUENCE; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_health_checks; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.network_health_checks OWNER TO stayconnect;

--
-- Name: network_interfaces; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.network_interfaces OWNER TO stayconnect;

--
-- Name: notification_providers; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.notification_providers OWNER TO stayconnect;

--
-- Name: operator_roles; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.operator_roles OWNER TO stayconnect;

--
-- Name: operators; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.operators OWNER TO stayconnect;

--
-- Name: otp_hmac_key_generations; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.otp_hmac_key_generations OWNER TO stayconnect;

--
-- Name: TABLE otp_hmac_key_generations; Type: COMMENT; Schema: public; Owner: stayconnect
--
...
--
-- Name: payments; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.payments OWNER TO stayconnect;

--
-- Name: pms_attempts; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.pms_attempts OWNER TO stayconnect;

--
-- Name: pms_providers; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.pms_providers OWNER TO stayconnect;

--
-- Name: schema_migrations; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.schema_migrations OWNER TO stayconnect;

--
-- Name: sessions; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.sessions OWNER TO stayconnect;

--
-- Name: sites; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.sites OWNER TO stayconnect;

--
-- Name: social_oauth_providers; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.social_oauth_providers OWNER TO stayconnect;

--
-- Name: social_oauth_states; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.social_oauth_states OWNER TO stayconnect;

--
-- Name: stripe_accounts; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.stripe_accounts OWNER TO stayconnect;

--
-- Name: stripe_events; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.stripe_events OWNER TO stayconnect;

--
-- Name: sync_checkpoints; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.sync_checkpoints OWNER TO stayconnect;

--
-- Name: sync_outbox; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.sync_outbox OWNER TO stayconnect;

--
-- Name: sync_outbox_seq_seq; Type: SEQUENCE; Schema: public; Owner: stayconnect
--
...
--
-- Name: system_network_audit; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.system_network_audit OWNER TO stayconnect;

--
-- Name: tenant_effective_limits; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.tenant_effective_limits OWNER TO stayconnect;

--
-- Name: tenants; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.tenants OWNER TO stayconnect;

--
-- Name: ticket_templates; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.ticket_templates OWNER TO stayconnect;

--
-- Name: voucher_batches; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.voucher_batches OWNER TO stayconnect;

--
-- Name: vouchers; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.vouchers OWNER TO stayconnect;

--
-- Name: walled_garden_rules; Type: TABLE; Schema: public; Owner: stayconnect
--
...
ALTER TABLE public.walled_garden_rules OWNER TO stayconnect;

--
-- Name: accounting_checkpoints accounting_checkpoints_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_checkpoints accounting_checkpoints_session_id_source_device_id_bridge_c_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_records accounting_records_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_records accounting_records_session_id_sample_seq_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: appliance_class_generation appliance_class_generation_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: appliance_product_setting_changes appliance_product_setting_changes_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: appliance_product_settings appliance_product_settings_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: auth_context_offers auth_context_offers_auth_context_id_package_revision_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_context_offers auth_context_offers_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_id_pms_interface_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_resolutions auth_resolutions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_alert_actions checkout_grace_alert_actions_audit_id_seq_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_alert_actions checkout_grace_alert_actions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit checkout_grace_audit_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit checkout_grace_audit_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit checkout_grace_audit_tenant_id_site_id_stay_id_lifecycle_ve_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_policy_publications checkout_grace_policy_publica_tenant_id_site_id_config_vers_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_policy_publications checkout_grace_policy_publications_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: compliance_archives compliance_archives_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: controlled_operation_scope controlled_operation_scope_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: delayed_accounting_records delayed_accounting_records_accounting_record_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: delayed_accounting_records delayed_accounting_records_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: device_network_appearances device_network_appearances_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: devices devices_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: devices devices_tenant_id_site_id_appliance_id_mac_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: devices devices_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_adjustments entitlement_adjustments_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_boundary_watermarks entitlement_boundary_watermarks_entitlement_id_boundary_at_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_boundary_watermarks entitlement_boundary_watermarks_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_device_authorizations entitlement_device_authorizati_entitlement_id_device_id_seq_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_device_authorizations entitlement_device_authorizations_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_devices entitlement_devices_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions entitlement_state_transitions_entitlement_id_seq_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions entitlement_state_transitions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions entitlement_state_transitions_supersedes_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_termination_evidence entitlement_termination_evidence_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: entitlement_transfers entitlement_transfers_from_entitlement_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_transfers entitlement_transfers_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_transfers entitlement_transfers_to_entitlement_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_purchase_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_supersedes_entitlement_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_epoch financial_epoch_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_epochs financial_epochs_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_recovery_holds financial_recovery_holds_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_recovery_holds financial_recovery_holds_tenant_id_site_id_epoch_work_kind__key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_restore_events financial_restore_events_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_restore_events financial_restore_events_tenant_id_site_id_restore_generati_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: folios folios_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: folios folios_tenant_id_site_id_pms_interface_id_external_folio_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: folios folios_tenant_id_site_id_pms_interface_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_access_accounts guest_access_accounts_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_access_accounts guest_access_accounts_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_device_actions guest_device_actions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: guest_network_pms_map guest_network_pms_map_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_principal_identities guest_principal_identities_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_principal_identities guest_principal_identities_tenant_id_factor_type_factor_iss_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_principals guest_principals_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_principals guest_principals_tenant_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_package_revisions internet_package_revisions_package_id_revision_no_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_package_revisions internet_package_revisions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_package_revisions internet_package_revisions_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_package_revisions internet_package_revisions_tenant_id_site_id_package_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_packages internet_packages_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_packages internet_packages_tenant_id_site_id_code_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_packages internet_packages_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes offer_quotes_id_auth_context_id_package_revision_id_pms_int_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes offer_quotes_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes offer_quotes_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: online_time_skipped_intervals online_time_skipped_intervals_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: package_eligibility_rules package_eligibility_rules_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_grant_tiers package_grant_tiers_package_revision_id_tier_order_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_grant_tiers package_grant_tiers_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_settlement_mappings package_settlement_mappings_package_revision_id_pms_interfa_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_settlement_mappings package_settlement_mappings_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_settlement_mappings package_settlement_mappings_tenant_id_site_id_package_revis_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_provider_accounts payment_provider_accounts_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_provider_accounts payment_provider_accounts_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_provider_accounts payment_provider_accounts_tenant_id_site_id_provider_mercha_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transaction_events payment_transaction_events_payment_transaction_id_provider__key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transaction_events payment_transaction_events_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions payment_transactions_idempotency_key_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions payment_transactions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions payment_transactions_tenant_id_provider_merchant_account_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions payment_transactions_tenant_id_site_id_settlement_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions payment_transactions_tsi_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_pnumber_seq pms_interface_pnumber_seq_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_revisions pms_interface_revisions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_revisions pms_interface_revisions_pms_interface_id_revision_no_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_revisions pms_interface_revisions_tenant_id_site_id_pms_interface_id__key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_runtime pms_interface_runtime_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_secret_generations pms_interface_secret_generati_pms_interface_id_generation_n_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_secret_generations pms_interface_secret_generati_tenant_id_site_id_pms_interfa_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_secret_generations pms_interface_secret_generations_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interfaces pms_interfaces_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interfaces pms_interfaces_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_id_pms_interface_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_idempotency_key_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_tenant_id_site_id_pms_interface_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_source_conflicts pms_source_conflicts_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_source_conflicts pms_source_conflicts_tenant_id_site_id_interface_a_interfac_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: post_stay_profiles post_stay_profiles_origin_stay_id_origin_lifecycle_version_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: post_stay_profiles post_stay_profiles_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: post_stay_profiles post_stay_profiles_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempt_events posting_attempt_events_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts posting_attempts_internal_posting_id_attempt_no_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts posting_attempts_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts posting_attempts_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts posting_attempts_tenant_id_site_id_pms_interface_id_p_numbe_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_outbox posting_outbox_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_review_actions posting_review_actions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_review_state posting_review_state_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_id_pms_interface_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_offer_quote_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plan_revisions service_plan_revisions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plan_revisions service_plan_revisions_service_plan_id_revision_no_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plan_revisions service_plan_revisions_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plan_revisions service_plan_revisions_tenant_id_site_id_service_plan_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plans service_plans_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plans service_plans_tenant_id_site_id_code_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plans service_plans_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_counter_watermarks session_counter_watermarks_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_entitlement_bindings session_entitlement_bindings_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_entitlement_bindings session_entitlement_bindings_session_id_seq_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_online_watermarks session_online_watermarks_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: sessions sessions_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: sessions sessions_tenant_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: sessions sessions_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: settlements settlements_id_purchase_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: settlements settlements_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: settlements settlements_purchase_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: settlements settlements_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: site_checkout_grace_config site_checkout_grace_config_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_events stay_events_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_events stay_events_scoped_identity; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_folios stay_folios_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_folios stay_folios_tenant_id_site_id_pms_interface_id_stay_id_foli_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_guests stay_guests_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_links stay_links_from_stay_to_stay_reason_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_links stay_links_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays stays_checkedout_needs_boundary; Type: CHECK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays stays_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays stays_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays stays_tenant_id_site_id_pms_interface_id_external_reservati_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays stays_tenant_id_site_id_pms_interface_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: voucher_batches voucher_batches_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: voucher_batches voucher_batches_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: voucher_code_key_generations voucher_code_key_generations_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: voucher_code_key_generations voucher_code_key_generations_tenant_id_generation_no_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: voucher_code_key_generations voucher_code_key_generations_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: vouchers vouchers_code_hmac_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: vouchers vouchers_pkey; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: vouchers vouchers_tenant_id_site_id_id_key; Type: CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: appliance_boot_convergence appliance_boot_convergence_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: appliance_recovery_events appliance_recovery_events_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: appliance_service_health appliance_service_health_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: appliances appliances_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: appliances appliances_serial_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_otps auth_otps_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_throttle_buckets auth_throttle_buckets_pk; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: backup_records backup_records_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: dhcp_pools dhcp_pools_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: dhcp_reservations dhcp_reservations_guest_network_id_mac_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: dhcp_reservations dhcp_reservations_guest_network_id_reserved_ip_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: dhcp_reservations dhcp_reservations_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: edge_executed_commands edge_executed_commands_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: edge_installed_updates edge_installed_updates_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: edge_offline_packages edge_offline_packages_nonce_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: edge_offline_packages edge_offline_packages_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: guest_accounts guest_accounts_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: guest_networks guest_networks_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: guests guests_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: guests guests_tenant_id_mac_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_apply_events network_apply_events_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_config_revisions network_config_revisions_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_config_revisions network_config_revisions_seq_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_health_checks network_health_checks_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_interfaces network_interfaces_name_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_interfaces network_interfaces_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: notification_providers notification_providers_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: operator_roles operator_roles_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: operators operators_email_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: operators operators_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: otp_hmac_key_generations otp_hmac_key_generations_pk; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: payments payments_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: payments payments_stripe_session_id_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_attempts pms_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_providers pms_providers_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: schema_migrations schema_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sites sites_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sites sites_tenant_id_code_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: social_oauth_providers social_oauth_providers_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: social_oauth_states social_oauth_states_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: stripe_accounts stripe_accounts_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: stripe_events stripe_events_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sync_checkpoints sync_checkpoints_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sync_outbox sync_outbox_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: system_network_audit system_network_audit_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: tenant_effective_limits tenant_effective_limits_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: tenants tenants_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: tenants tenants_slug_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: ticket_templates ticket_templates_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: ticket_templates ticket_templates_tenant_id_code_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: voucher_batches voucher_batches_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: vouchers vouchers_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: vouchers vouchers_tenant_id_code_key; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: walled_garden_rules walled_garden_rules_pkey; Type: CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: ac_one_live_per_resolution; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: aco_by_context; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: aps_changes_lookup; Type: INDEX; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: auth_resolutions_req_idem; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: eda_boundary_lookup; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ent_live_account; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ent_live_principal; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ent_live_stay; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ent_live_voucher; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: est_boundary_lookup; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: fin_epoch_one_open_per_site; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: fin_holds_open; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: fin_restore_events_site; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: folio_open_identity; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: gaa_username; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: gda_lookup; Type: INDEX; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: gda_release_rate; Type: INDEX; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: gnpm_one_default; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_packages_active_lookup; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes_auth_context; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes_open_expiry; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: one_conversion_per_episode; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: one_primary_guest_per_stay; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: online_time_skipped_intervals_ent_idx; Type: INDEX; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: outbox_backlog_age; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: outbox_one_active; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: outbox_one_inflight_per_interface; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: INDEX outbox_one_inflight_per_interface; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_eligibility_rules_by_revision; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_revision_visibility; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: post_stay_profiles_origin; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts_by_posting; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ppa_merchant_ref_globally_unique; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: INDEX ppa_merchant_ref_globally_unique; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ppa_one_default_per_site; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ptx_event_provider_identity; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: INDEX ptx_event_provider_identity; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ptx_events_by_txn; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ptx_one_live_charge_per_settlement; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: INDEX ptx_one_live_charge_per_settlement; Type: COMMENT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: ptx_provider_txn_ref_identity; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchase_once_per_stay; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases_auth_context; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: se_live_identity; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: se_resync_identity; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: seb_attribution; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: seb_one_open; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_folio_default; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays_effective_checkout; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays_room_lookup; Type: INDEX; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_records_session_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: accounting_records_tenant_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: accounting_records_ts_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: appliances_tenant_site_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: appliances_tsi_anchor; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: INDEX appliances_tsi_anchor; Type: COMMENT; Schema: public; Owner: stayconnect
--
...
--
-- Name: audit_log_tenant_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: audit_log_ts_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_otps_dest_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_otps_recent_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_throttle_buckets_block; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_throttle_buckets_expiry; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: dhcp_pools_network_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: guest_accounts_tenant_idx; Type: INDEX; Schema: public; Owner: stayconnect
--

CREATE INDEX guest_accounts_tenant_idx ON public.guest_accounts USING btree (tenant_id);


--
-- Name: guest_accounts_tenant_username_uniq; Type: INDEX; Schema: public; Owner: stayconnect
--

CREATE UNIQUE INDEX guest_accounts_tenant_username_uniq ON public.guest_accounts USING btree (tenant_id, lower(username));


--
-- Name: guest_networks_bridge_uniq; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: guest_networks_enabled_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: guest_networks_tsi_anchor; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: guest_networks_untagged_parent_uniq; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: guest_networks_vlan_parent_uniq; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: guests_email_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: guests_phone_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: nae_revision_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: ncr_single_inflight; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: ncr_state_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: nhc_revision_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: notification_providers_tenant_channel_enabled_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: operator_roles_uniq; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: operators_oidc_sub_uniq; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: otp_hmac_key_generations_one_active; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: payments_tenant_status_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_attempts_ip_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_attempts_room_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_providers_tenant_enabled_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_providers_tenant_name_global_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_providers_tenant_site_enabled_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_providers_tenant_site_name_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: recovery_events_created_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: recovery_events_service_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions_active_expires_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions_active_idle_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions_appliance_active_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions_guest_network_idx; Type: INDEX; Schema: public; Owner: stayconnect
--

CREATE INDEX sessions_guest_network_idx ON public.sessions USING btree (guest_network_id) WHERE (state = 'active'::text);


--
-- Name: sessions_tenant_active_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: social_oauth_providers_tenant_provider_enabled_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: social_oauth_states_expiry_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: stripe_accounts_tenant_enabled_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: stripe_events_received_at_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: sync_outbox_pending_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: system_network_audit_created_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: system_network_audit_revision_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: voucher_batches_tenant_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: vouchers_batch_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: vouchers_code_global_uniq; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: vouchers_state_idx; Type: INDEX; Schema: public; Owner: stayconnect
--
...
--
-- Name: accounting_records ao_accounting; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_adjustments ao_adjust; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempt_events ao_pa_events; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings ao_postings; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transaction_events ao_ptx_events; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: financial_recovery_holds ao_recovery_holds; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_review_actions ao_review; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings charge_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements ent_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_package_revisions imm_pkg_rev; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plan_revisions imm_plan_rev; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_revisions imm_pms_rev; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes offer_quote_immutable; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_checkpoints p3_accounting_checkpoints_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_records p3_accounting_needs_binding; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_records p3_accounting_records_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_alert_actions p3_alert_action_appendonly; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_alert_actions p3_alert_action_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_alert_actions p3_alert_action_insert; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit p3_alert_open_on_audit; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts p3_auth_context_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_context_offers p3_auth_context_offers_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_resolutions p3_auth_resolution_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_boundary_watermarks p3_boundary_watermark_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit p3_checkout_audit_provenance; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit p3_checkout_conversion_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit p3_checkout_grace_audit_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: appliance_class_generation p3_class_generation_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: delayed_accounting_records p3_dar_appendonly; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: delayed_accounting_records p3_delayed_accounting_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_records p3_detect_delayed_accounting; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_device_authorizations p3_device_auth_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_boundary_watermarks p3_ebw_appendonly; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_device_authorizations p3_eda_appendonly; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_device_authorizations p3_eda_insert; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements p3_entitlement_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements p3_entitlement_status_coherent; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions p3_est_appendonly; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions p3_est_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions p3_est_insert; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: site_checkout_grace_config p3_grace_config_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: site_checkout_grace_config p3_grace_config_version_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_policy_publications p3_grace_publication_appendonly; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_policy_publications p3_grace_publication_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: controlled_operation_scope p3_operation_scope_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases p3_purchase_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes p3_quote_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_packages p3_reserved_grace_pkg; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plans p3_reserved_grace_plan; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_entitlement_bindings p3_seb_appendonly; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_entitlement_bindings p3_seb_insert; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_entitlement_bindings p3_session_binding_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: sessions p3_session_close_binding; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: sessions p3_session_open_binding; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: sessions p3_session_usage_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_source_conflicts p3_source_conflict_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays p3_stay_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_events p3_stay_event_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_events p3_stay_event_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays p3_stay_lifecycle_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts p4_attempt_lifecycle_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts p4_attempt_retry_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts p4_consume_retry_authorization; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings p4_fias_exponent_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interfaces p4_interface_decommission_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_outbox p4_outbox_recovery_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions p4_payment_admission_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions p4_payment_creation_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions p4_payment_identity_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions p4_payment_status_machine; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings p4_posting_currency_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings p4_posting_lifecycle_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_outbox p4_recovery_gate_outbox; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions p4_recovery_gate_payments; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings p4_reversal_ledger_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts p4_reversal_never_attempted; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_outbox p4_reversal_never_queued; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_review_actions p4_review_writer_only; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: settlements p4_settlement_state_machine; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts p4_zz_attempt_freshness_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings p4_zz_posting_freshness_gate; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_transfers p5_entitlement_transfer_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_transfers p5_entitlement_transfer_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: post_stay_profiles p5_post_stay_profile_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: post_stay_profiles p5_post_stay_profile_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_links p5_stay_link_controlled_writer; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_links p5_stay_link_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_device_actions p6_guest_device_actions_append_only; Type: TRIGGER; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: session_online_watermarks p6_online_watermark_monotonic; Type: TRIGGER; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: sessions p6_session_requires_authorized_binding; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: appliance_product_setting_changes p6_setting_changes_append_only; Type: TRIGGER; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: online_time_skipped_intervals p6_skipped_intervals_append_only; Type: TRIGGER; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: entitlement_termination_evidence p6_termination_evidence_append_only; Type: TRIGGER; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: entitlement_termination_evidence p6_termination_evidence_matches_transition; Type: TRIGGER; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: posting_attempts pa_oneway; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchase_quote_pin_equal; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_secret_generations sg_guard; Type: TRIGGER; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_records ts_insert_blocker; Type: TRIGGER; Schema: public; Owner: stayconnect
--
...
--
-- Name: audit_log ts_insert_blocker; Type: TRIGGER; Schema: public; Owner: stayconnect
--
...
--
-- Name: accounting_checkpoints accounting_checkpoints_tenant_id_site_id_session_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: accounting_records accounting_records_tenant_id_site_id_session_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: appliance_product_setting_changes appliance_product_setting_changes_changed_by_operator_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: appliance_product_settings aps_appliance_must_exist; Type: FK CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: appliance_product_setting_changes apsc_appliance_must_exist; Type: FK CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: auth_context_offers auth_context_offers_tenant_id_site_id_auth_context_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_context_offers auth_context_offers_tenant_id_site_id_package_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_guest_principal_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_site_id_device_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_site_id_guest_account_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_site_id_guest_network_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_site_id_pms_interface_id_authentic_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_site_id_pms_interface_id_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_site_id_post_stay_profile_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_contexts auth_contexts_tenant_id_site_id_voucher_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_resolutions auth_resolutions_tenant_id_site_id_guest_network_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: auth_resolutions auth_resolutions_tenant_id_site_id_resolved_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_alert_actions checkout_grace_alert_actions_tenant_id_site_id_audit_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit checkout_grace_audit_tenant_id_site_id_grace_entitlement_i_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: checkout_grace_audit checkout_grace_audit_tenant_id_site_id_pms_interface_id_st_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: delayed_accounting_records delayed_accounting_records_watermark_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: device_network_appearances device_network_appearances_tenant_id_site_id_device_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: device_network_appearances device_network_appearances_tenant_id_site_id_guest_network_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_adjustments entitlement_adjustments_tenant_id_site_id_entitlement_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_boundary_watermarks entitlement_boundary_watermar_tenant_id_site_id_entitlemen_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_device_authorizations entitlement_device_authorizat_tenant_id_site_id_entitlemen_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_device_authorizations entitlement_device_authorizati_tenant_id_site_id_device_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_devices entitlement_devices_tenant_id_site_id_device_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_devices entitlement_devices_tenant_id_site_id_entitlement_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions entitlement_state_transitions_superseded_by_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions entitlement_state_transitions_supersedes_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_state_transitions entitlement_state_transitions_tenant_id_site_id_entitlemen_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_termination_evidence entitlement_termination_evide_tenant_id_site_id_entitlemen_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: entitlement_transfers entitlement_transfers_tenant_id_site_id_from_entitlement_i_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_transfers entitlement_transfers_tenant_id_site_id_from_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_transfers entitlement_transfers_tenant_id_site_id_to_entitlement_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlement_transfers entitlement_transfers_tenant_id_site_id_to_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_guest_principal_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_site_id_guest_account_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_site_id_package_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_site_id_pms_interface_id_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_site_id_purchase_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_site_id_service_plan_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_site_id_supersedes_entitlement_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: entitlements entitlements_tenant_id_site_id_voucher_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: folios folios_tenant_id_site_id_pms_interface_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_access_accounts guest_access_accounts_tenant_id_site_id_assigned_package_i_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_device_actions guest_device_actions_tenant_id_site_id_entitlement_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: guest_network_pms_map guest_network_pms_map_tenant_id_site_id_guest_network_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_network_pms_map guest_network_pms_map_tenant_id_site_id_pms_interface_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: guest_principal_identities guest_principal_identities_tenant_id_guest_principal_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_package_revisions internet_package_revisions_tenant_id_site_id_package_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_package_revisions internet_package_revisions_tenant_id_site_id_service_plan__fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: internet_packages internet_packages_tenant_id_site_id_id_current_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes offer_quotes_tenant_id_site_id_auth_context_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes offer_quotes_tenant_id_site_id_package_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: offer_quotes offer_quotes_tenant_id_site_id_package_revision_id_pms_int_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_eligibility_rules package_eligibility_rules_tenant_id_site_id_package_revisi_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_grant_tiers package_grant_tiers_tenant_id_site_id_package_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_settlement_mappings package_settlement_mappings_tenant_id_site_id_package_revi_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: package_settlement_mappings package_settlement_mappings_tenant_id_site_id_pms_interfac_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transaction_events payment_transaction_events_tenant_id_site_id_payment_trans_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions payment_transactions_tenant_id_site_id_settlement_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions payment_transactions_tenant_id_site_id_settlement_id_paren_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_pnumber_seq pms_interface_pnumber_seq_tenant_id_site_id_pms_interface__fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_revisions pms_interface_revisions_tenant_id_site_id_pms_interface_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_runtime pms_interface_runtime_tenant_id_site_id_pms_interface_id__fkey1; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_runtime pms_interface_runtime_tenant_id_site_id_pms_interface_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_runtime pms_interface_runtime_tenant_id_site_id_pms_interface_id_p_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interface_secret_generations pms_interface_secret_generati_tenant_id_site_id_pms_interf_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_interfaces pms_interfaces_tenant_id_site_id_id_current_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_purchase_id_pms_interface_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_settlement_id_purchase_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_tenant_id_site_id_pms_interface_id_folio_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_tenant_id_site_id_pms_interface_id_posting_in_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_tenant_id_site_id_pms_interface_id_secret_gen_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_tenant_id_site_id_pms_interface_id_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_tenant_id_site_id_purchase_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_postings pms_postings_tenant_id_site_id_settlement_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_source_conflicts pms_source_conflicts_tenant_id_site_id_interface_a_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: pms_source_conflicts pms_source_conflicts_tenant_id_site_id_interface_b_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: post_stay_profiles post_stay_profiles_tenant_id_site_id_origin_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempt_events posting_attempt_events_tenant_id_site_id_posting_attempt_i_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts posting_attempts_tenant_id_site_id_internal_posting_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_attempts posting_attempts_tenant_id_site_id_pms_interface_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_outbox posting_outbox_tenant_id_site_id_pms_interface_id_posting__fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_review_actions posting_review_actions_tenant_id_site_id_posting_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: posting_review_state posting_review_state_tenant_id_site_id_posting_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: payment_transactions ptx_merchant_account_configured; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_offer_quote_id_auth_context_id_package_revision__fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_tenant_id_site_id_package_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_tenant_id_site_id_package_revision_id_pms_interf_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_tenant_id_site_id_pms_interface_id_authenticatio_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: purchases purchases_tenant_id_site_id_pms_interface_id_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plan_revisions service_plan_revisions_tenant_id_site_id_service_plan_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: service_plans service_plans_tenant_id_site_id_id_current_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_counter_watermarks session_counter_watermarks_tenant_id_site_id_session_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_entitlement_bindings session_entitlement_bindings_tenant_id_site_id_entitlement_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_entitlement_bindings session_entitlement_bindings_tenant_id_site_id_session_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: session_online_watermarks session_online_watermarks_tenant_id_site_id_session_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: sessions sessions_tenant_id_site_id_device_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: sessions sessions_tenant_id_site_id_entitlement_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: settlements settlements_tenant_id_site_id_purchase_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: site_checkout_grace_config site_checkout_grace_config_tenant_id_site_id_grace_package_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_events stay_events_tenant_id_site_id_pms_interface_id_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_folios stay_folios_tenant_id_site_id_pms_interface_id_folio_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_folios stay_folios_tenant_id_site_id_pms_interface_id_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_guests stay_guests_tenant_id_site_id_pms_interface_id_stay_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_links stay_links_tenant_id_site_id_from_stay_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stay_links stay_links_tenant_id_site_id_to_stay_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays stays_last_applied_event_scoped; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays stays_occupancy_revision_fk; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: stays stays_tenant_id_site_id_pms_interface_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: voucher_batches voucher_batches_tenant_id_site_id_package_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: vouchers vouchers_tenant_id_site_id_code_key_generation_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: vouchers vouchers_tenant_id_site_id_package_revision_id_fkey; Type: FK CONSTRAINT; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: appliances appliances_site_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: appliances appliances_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_otps auth_otps_appliance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_otps auth_otps_otp_key_generation_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_otps auth_otps_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: auth_otps auth_otps_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: dhcp_pools dhcp_pools_guest_network_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: dhcp_reservations dhcp_reservations_guest_network_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: guest_accounts guest_accounts_site_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--

ALTER TABLE ONLY public.guest_accounts
    ADD CONSTRAINT guest_accounts_site_id_fkey FOREIGN KEY (site_id) REFERENCES public.sites(id) ON DELETE SET NULL;


--
-- Name: guest_accounts guest_accounts_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--

ALTER TABLE ONLY public.guest_accounts
    ADD CONSTRAINT guest_accounts_template_id_fkey FOREIGN KEY (template_id) REFERENCES public.ticket_templates(id) ON DELETE RESTRICT;


--
-- Name: guest_accounts guest_accounts_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--

ALTER TABLE ONLY public.guest_accounts
    ADD CONSTRAINT guest_accounts_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: guests guests_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_apply_events network_apply_events_revision_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: network_health_checks network_health_checks_revision_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: notification_providers notification_providers_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: operator_roles operator_roles_operator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: operator_roles operator_roles_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: operators operators_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: payments payments_site_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: payments payments_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: payments payments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: payments payments_voucher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_attempts pms_attempts_appliance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_attempts pms_attempts_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_providers pms_providers_site_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: pms_providers pms_providers_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions sessions_appliance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--

ALTER TABLE ONLY public.sessions
    ADD CONSTRAINT sessions_appliance_id_fkey FOREIGN KEY (appliance_id) REFERENCES public.appliances(id) ON DELETE CASCADE;


--
-- Name: sessions sessions_guest_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--

ALTER TABLE ONLY public.sessions
    ADD CONSTRAINT sessions_guest_account_id_fkey FOREIGN KEY (guest_account_id) REFERENCES public.guest_accounts(id) ON DELETE SET NULL;


--
-- Name: sessions sessions_guest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions sessions_site_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions sessions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sessions sessions_voucher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: sites sites_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: social_oauth_providers social_oauth_providers_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: social_oauth_states social_oauth_states_appliance_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: social_oauth_states social_oauth_states_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: social_oauth_states social_oauth_states_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: stripe_accounts stripe_accounts_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: stripe_events stripe_events_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: ticket_templates ticket_templates_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: voucher_batches voucher_batches_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: voucher_batches voucher_batches_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: voucher_batches voucher_batches_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: vouchers vouchers_batch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: vouchers vouchers_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: vouchers vouchers_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: walled_garden_rules walled_garden_rules_site_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: walled_garden_rules walled_garden_rules_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stayconnect
--
...
--
-- Name: SCHEMA iam_v2; Type: ACL; Schema: -; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION activate_session_enforcement(p_tenant uuid, p_site uuid, p_session uuid, p_bridge text, p_class_minor integer, p_epoch bigint); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION allocate_class_generation(p_tenant uuid, p_site uuid, p_appliance uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION allocate_p_number(p_tenant uuid, p_site uuid, p_interface uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION apply_entitlement_transition(p_ent uuid, p_to text, p_at timestamp with time zone, p_reason text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION apply_payment_callback_v2(p_tenant uuid, p_provider text, p_merchant uuid, p_client_ref text, p_provider_event_id text, p_event_type text, p_asserted_status text, p_provider_txn_ref text, p_evidence jsonb); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION authorize_entitlement_device(p_ent uuid, p_device uuid, p_at timestamp with time zone); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION begin_controlled_operation(p_family text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION begin_payment_execution(p_txn uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION bootstrap_emergency_grace(p_tenant uuid, p_site uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION deauthorize_entitlement_device(p_ent uuid, p_device uuid, p_at timestamp with time zone, p_reason text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION emergency_grace_health(p_tenant uuid, p_site uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION end_session_enforcement(p_tenant uuid, p_site uuid, p_session uuid, p_reason text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION entitlement_usage_bytes(p_ent uuid, p_at timestamp with time zone); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION grace_package_matches_policy(p_tenant uuid, p_site uuid, p_pkg_rev uuid, p_duration integer, p_down integer, p_up integer, p_quota bigint, p_dev_limit integer, p_dev_policy text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION grace_package_mismatch_reason(p_tenant uuid, p_site uuid, p_pkg_rev uuid, p_duration integer, p_down integer, p_up integer, p_quota bigint, p_dev_limit integer, p_dev_policy text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION ingest_absolute_counters(p_tenant uuid, p_site uuid, p_session uuid, p_source_device uuid, p_bridge text, p_class_minor integer, p_epoch bigint, p_abs_up bigint, p_abs_down bigint, p_sampled_at timestamp with time zone); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION issue_or_return_pms_context(p_tenant uuid, p_site uuid, p_interface uuid, p_revision uuid, p_stay uuid, p_device uuid, p_guest_network uuid, p_request uuid, p_ttl_seconds integer); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_accounting_needs_binding(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_alert_action_guard(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_alert_open_on_audit(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_checkout_audit_provenance(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_checkout_grace_audit_appendonly(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_controlled_operation_open(p_family text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_controlled_writer_only(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_controlled_writer_owner(p_family text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_detect_delayed_accounting(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_eda_insert_guard(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_entitlement_at(p_session uuid, p_at timestamp with time zone); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_entitlement_status_coherent(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_est_insert_guard(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_expected_class_minor(p_ip inet); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_grace_config_version_guard(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_history_appendonly(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_rederive_entitlement_times(p_ent uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_reserved_grace_codes(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_seb_appendonly(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_session_close_binding(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_session_open_binding(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_stay_event_appendonly(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p3_stay_lifecycle_guard(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_apply_provider_outcome(p_client_ref text, p_provider_event_id text, p_event_type text, p_outcome text, p_provider_txn_ref text, p_evidence jsonb); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_assert_compliance_archived(p_tenant uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_assert_financial_actor(p_tenant uuid, p_actor uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_authorize_zero_attempt_retry(p_posting uuid, p_actor uuid, p_reason text, p_evidence jsonb); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_current_restore_generation(p_tenant uuid, p_site uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_declare_financial_recovery(p_tenant uuid, p_site uuid, p_actor uuid, p_reason text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_entitlement_grant_kernel(p_tenant uuid, p_site uuid, p_purchase uuid, p_voucher uuid, p_account uuid, p_principal uuid, p_snapshot jsonb, p_plan_rev uuid, p_pkg_rev uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_financial_recovery_active(p_tenant uuid, p_site uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_grant_paid_entitlement(p_tenant uuid, p_site uuid, p_settlement uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_grant_quoted_entitlement(p_tenant uuid, p_site uuid, p_purchase uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_hold_financial_rails(p_tenant uuid, p_site uuid, p_epoch bigint); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_insert_entitlement(p_tenant uuid, p_site uuid, p_voucher uuid, p_account uuid, p_principal uuid, p_purchase uuid, p_policy jsonb, p_plan_rev uuid, p_pkg_rev uuid, p_time_mode text, p_end_mode text, p_window_ends timestamp with time zone, p_supersedes uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_mark_purchase_granted(p_purchase uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_outbox_recovery_gate(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_payment_admission_gate(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_payment_identity_gate(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_reconcile_financial_epoch(p_tenant uuid, p_site uuid, p_system_identity text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_reconcile_financial_epoch_v2(p_tenant uuid, p_site uuid, p_system_identity text, p_marker_generation bigint, p_marker_present boolean); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_record_compliance_archive(p_tenant uuid, p_site uuid, p_manifest_sha text, p_artifact_path text, p_row_counts jsonb); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_record_compliance_receipt(p_archive uuid, p_authority text, p_reference text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_record_supported_restore(p_tenant uuid, p_site uuid, p_generation bigint, p_manifest_sha text, p_backup_taken_at timestamp with time zone, p_restored_by text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_recovery_gate(); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_release_financial_recovery(p_tenant uuid, p_site uuid, p_actor uuid, p_note text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_resolve_payment_account(p_tenant uuid, p_site uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_resolve_recovery_hold(p_hold uuid, p_resolution text, p_actor uuid, p_note text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p4_terminate_live_entitlement_for_subject(p_tenant uuid, p_site uuid, p_voucher uuid, p_account uuid, p_principal uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION p5_begin_controlled_operation(p_family text); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p5_controlled_writer_only(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p5_entitlement_transfer_guard(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p5_post_stay_authenticable(p_tenant uuid, p_site uuid, p_profile uuid); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p5_post_stay_profile_guard(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p5_stay_link_guard(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_data_crossing(p_entitlement uuid); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_due_terminal(p_entitlement uuid); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_exhaustion_instant(p_entitlement uuid); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_expire_entitlement(p_entitlement uuid); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_guest_device_actions_append_only(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_guest_release_device(p_entitlement uuid, p_device uuid, p_max_releases_per_hour integer); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_guest_release_device_policy(p_entitlement uuid, p_device uuid); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_online_watermark_monotonic(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_over_budget_now(p_entitlement uuid); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_record_time_termination(p_entitlement uuid, p_cause text); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_session_requires_authorized_binding(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_set_guest_device_self_service(p_tenant uuid, p_site uuid, p_appliance uuid, p_on boolean, p_operator uuid, p_operator_label text, p_reason text); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_setting_changes_append_only(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_skipped_intervals_append_only(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_suspend_over_budget(p_tenant uuid, p_site uuid); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_termination_evidence_append_only(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_termination_evidence_matches_transition(); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION p6_tick_online_time(p_tenant uuid, p_site uuid, p_now timestamp with time zone, p_max_charge_seconds integer, p_capped_entitlements uuid[], p_caps timestamp with time zone[]); Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: FUNCTION publish_checkout_grace_config(p_tenant uuid, p_site uuid, p_pkg_rev uuid, p_duration integer, p_down integer, p_up integer, p_quota bigint, p_dev_limit integer, p_dev_policy text, p_eligibility integer); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION publish_checkout_grace_policy(p_tenant uuid, p_site uuid, p_pkg_rev uuid, p_duration integer, p_down integer, p_up integer, p_quota bigint, p_dev_limit integer, p_dev_policy text, p_eligibility integer, p_expected_version integer, p_actor uuid, p_reason text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION rebind_session_entitlement(p_session uuid, p_ent uuid, p_at timestamp with time zone); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION record_alert_action(p_tenant uuid, p_site uuid, p_audit uuid, p_action text, p_actor uuid, p_reason text, p_expected_state text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION record_auth_context_offer(p_tenant uuid, p_site uuid, p_auth_context uuid, p_package_revision uuid, p_tier integer, p_evidence_version bigint, p_expires_at timestamp with time zone); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION record_posting_review_action(p_posting uuid, p_action text, p_actor uuid, p_reason text, p_evidence jsonb, p_expected_version integer, p_reversal_amount bigint); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION register_class_origin(p_tenant uuid, p_site uuid, p_session uuid, p_source_device uuid, p_bridge text, p_class_minor integer, p_epoch bigint, p_origin_up bigint, p_origin_down bigint, p_created_at timestamp with time zone); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION selectable_grace_packages(p_tenant uuid, p_site uuid); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION supersede_entitlement_transition(p_target uuid, p_to text, p_at timestamp with time zone, p_reason text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: FUNCTION terminate_entitlement_at_boundary(p_ent uuid, p_at timestamp with time zone, p_reason text); Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE accounting_records; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE audit_log; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE accounting_records; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--

GRANT SELECT ON TABLE iam_v2.accounting_records TO svc_acctd;


--
-- Name: TABLE appliance_product_settings; Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: TABLE auth_contexts; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE devices; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--

GRANT SELECT,INSERT ON TABLE iam_v2.devices TO svc_scd;


--
-- Name: COLUMN devices.mac; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--

GRANT UPDATE(mac) ON TABLE iam_v2.devices TO svc_scd;


--
-- Name: COLUMN devices.last_seen; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--

GRANT UPDATE(last_seen) ON TABLE iam_v2.devices TO svc_scd;


--
-- Name: COLUMN devices.last_ip; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--

GRANT UPDATE(last_ip) ON TABLE iam_v2.devices TO svc_scd;


--
-- Name: TABLE entitlement_devices; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE entitlement_state_transitions; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE entitlement_termination_evidence; Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: TABLE entitlements; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--

GRANT SELECT ON TABLE iam_v2.entitlements TO sc_payment_runtime;
GRANT SELECT ON TABLE iam_v2.entitlements TO svc_acctd;
GRANT SELECT ON TABLE iam_v2.entitlements TO svc_scd;


--
-- Name: TABLE financial_epochs; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE financial_recovery_holds; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE financial_restore_events; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE internet_package_revisions; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE offer_quotes; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE payment_provider_accounts; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE payment_transaction_events; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE payment_transactions; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE pms_postings; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE posting_outbox; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE posting_review_state; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE posting_review_actions; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE purchases; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE service_plan_revisions; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE session_entitlement_bindings; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--

GRANT SELECT ON TABLE iam_v2.session_entitlement_bindings TO svc_acctd;


--
-- Name: TABLE session_online_watermarks; Type: ACL; Schema: iam_v2; Owner: stayconnect
--
...
--
-- Name: TABLE sessions; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--

GRANT SELECT,INSERT ON TABLE iam_v2.sessions TO svc_scd;
GRANT SELECT ON TABLE iam_v2.sessions TO svc_acctd;


--
-- Name: TABLE settlements; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE v_financial_payments; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE v_financial_recovery; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE v_financial_review_queue; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE v_financial_settlements; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE v_zero_attempt_recovery_queue; Type: ACL; Schema: iam_v2; Owner: iam_v2_owner
--
...
--
-- Name: TABLE appliance_boot_convergence; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE appliance_recovery_events; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: SEQUENCE appliance_recovery_events_id_seq; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE appliance_service_health; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,INSERT ON TABLE public.appliance_service_health TO svc_edged;


--
-- Name: TABLE appliances; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE auth_otps; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE auth_throttle_buckets; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE backup_records; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE dhcp_pools; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE dhcp_reservations; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE edge_executed_commands; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE edge_installed_updates; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE edge_offline_packages; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE guest_accounts; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,DELETE,UPDATE ON TABLE public.guest_accounts TO svc_scd;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.guest_accounts TO svc_edged;


--
-- Name: TABLE guest_networks; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE guests; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,INSERT,UPDATE ON TABLE public.guests TO svc_scd;


--
-- Name: TABLE network_apply_events; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE network_config_revisions; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: SEQUENCE network_config_revisions_seq_seq; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE network_health_checks; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE network_interfaces; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE notification_providers; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE operator_roles; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE operators; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE otp_hmac_key_generations; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE payments; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,DELETE ON TABLE public.payments TO svc_scd;
GRANT SELECT ON TABLE public.payments TO svc_edged;


--
-- Name: TABLE pms_attempts; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE pms_providers; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE schema_migrations; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,INSERT ON TABLE public.schema_migrations TO iam_v2_owner;


--
-- Name: TABLE sessions; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,INSERT,UPDATE ON TABLE public.sessions TO svc_scd;
GRANT SELECT ON TABLE public.sessions TO svc_edged;
GRANT SELECT,UPDATE ON TABLE public.sessions TO svc_acctd;


--
-- Name: TABLE sites; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE social_oauth_providers; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE social_oauth_states; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE stripe_accounts; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE stripe_events; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE sync_checkpoints; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE sync_outbox; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: SEQUENCE sync_outbox_seq_seq; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE system_network_audit; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE tenant_effective_limits; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE tenants; Type: ACL; Schema: public; Owner: stayconnect
--
...
--
-- Name: TABLE ticket_templates; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,DELETE ON TABLE public.ticket_templates TO svc_scd;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.ticket_templates TO svc_edged;
GRANT SELECT ON TABLE public.ticket_templates TO svc_acctd;


--
-- Name: TABLE voucher_batches; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,DELETE ON TABLE public.voucher_batches TO svc_scd;
GRANT SELECT,INSERT ON TABLE public.voucher_batches TO svc_edged;


--
-- Name: TABLE vouchers; Type: ACL; Schema: public; Owner: stayconnect
--

GRANT SELECT,DELETE,UPDATE ON TABLE public.vouchers TO svc_scd;
GRANT SELECT,INSERT,UPDATE ON TABLE public.vouchers TO svc_edged;
GRANT SELECT ON TABLE public.vouchers TO svc_acctd;


--
-- Name: TABLE walled_garden_rules; Type: ACL; Schema: public; Owner: stayconnect
--
