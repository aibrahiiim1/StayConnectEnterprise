...
| `hotel-admin`   | Velonet Hotel Admin — the Next.js console served by each appliance   |
| `cloud-admin`   | Velonet Central — the vendor's Next.js licensing console              |
| `design-system` | The Velonet design system: canonical tokens and the component and pattern guide shared by all three front-ends |
| `web-admin`     | The pre-split admin UI (legacy, out of scope for the Velonet front-ends) |
...
The product's user-facing name is **Velonet**. Its three front-ends — the guest portal (served by
