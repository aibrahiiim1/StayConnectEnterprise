...
-- ---- the operator surface (migration 0087) ----------------------------------------------------------
...
-- redemption burn into the entitlement kernel rather than widen that privilege, and 0087 does the same for
...
-- ---- rotation (migration 0087, the same migration as the block above) -------------------------------
