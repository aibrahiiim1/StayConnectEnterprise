  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "transition-colors duration-base ease-velonet focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
    ...
    >
      <SwitchPrimitive.Thumb
        className={cn(
          "pointer-events-none block size-5 rounded-full bg-white shadow-control ring-0 transition-transform duration-base ease-velonet",
